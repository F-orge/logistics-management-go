import { columns } from "@/components/tables/billing/account_transactions";
import {
  TransactionType,
  execute,
...
export const Route = createFileRoute("/dashboard/billing/account-transactions")(
  {
    ...
    loader: async ({ context }) => {
      const result = await execute("/api/graphql", AccountTransactionsQuery, {
      ...
      return result.data?.billing?.accountTransactions || [];
    },
  }
);
