import { columns } from "@/components/tables/wms/locations";
import {
  LocationType,
  execute,
  TableLocationQuery,
...
export const Route = createFileRoute("/dashboard/wms/locations")({
  ...
  loader: async ({ context }) => {
    const result = await execute("/api/graphql", TableLocationQuery, {
    ...
    return result.data?.wms?.locations || [];
  },
});
