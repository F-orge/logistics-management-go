...
export type InventoryItemsOverallKPIRecord<TtotalQuantityOnHandAllProducts = unknown> = {
...
export type InventoryItemsProductKPIRecord<TproductId = unknown, TtotalQuantityforProduct = unknown> = {
	id: string
	productId?: null | TproductId
	totalQuantityforProduct?: null | TtotalQuantityforProduct
}

export type InventoryItemsStatusKPIRecord<TquantityByStatus = unknown, Tstatus = unknown> = {
	id: string
...
export type InventoryItemsWarehouseKPIRecord<TtotalQuantityInWarehouse = unknown, TwarehouseId = unknown> = {
	id: string
...
export type InvoicesOverallKPIRecord<TtotalAmountFromPaidInvoice = unknown, TtotalInvoiceAmount = unknown, TtotalOverdueAmount = unknown> = {
	id: string
...
export type OrderLineItemsOverallKPIRecord<TaveragePricePerUnit = unknown, TaverageQuantityPerLine = unknown, TtotalQuantitySold = unknown, TtotalSubtotalRevenue = unknown> = {
...
export type OrderLineItemsRevenueRecord<TproductId = unknown, TrevenuePerProduct = unknown> = {
	id: string
	productId?: null | TproductId
	revenuePerProduct?: null | TrevenuePerProduct
}

export type OrderLineItemsTopSellingKPIRecord<TproductId = unknown, TtotalQuantitySold = unknown, TtotalRevenueFromProduct = unknown> = {
	id: string
	productId?: null | TproductId
	totalQuantitySold?: null | TtotalQuantitySold
...
export type OrdersMonthlyKPIRecord<TmontlyRevenue = unknown, TyearMonth = unknown> = {
	id: string
...
export type OrdersOverallKPIRecord<TaverageOrderValue = unknown, TtotalRevenueFromOrders = unknown> = {
...
export type PaymentsOverallKPIRecord<TaveragePaymentAmount = unknown, TtotalAmountPaid = unknown> = {
...
export type RouteSegmentsAverageTimeKPIRecord<TavgDurationMinutesAtSegment = unknown, TsegmentType = unknown> = {
...
export type ShipmentsOnTimeDeliveryKPIRecord<TonTimeDeliveryPercentage = unknown, TonTimeShipments = unknown> = {
	id: string
...
export type VehiclesOverallKPIRecord<TaverageVolumeCapacity = unknown, TaverageWeightCapacity = unknown> = {
...
export type ChatMessagesOverallKPIResponse<Texpand = unknown> = Required<ChatMessagesOverallKPIRecord> & BaseSystemFields<Texpand>
export type ChatMessagesPerRoomKPIResponse<TroomID = unknown, Texpand = unknown> = Required<ChatMessagesPerRoomKPIRecord<TroomID>> & BaseSystemFields<Texpand>
export type ChatMessagesSenderKPIResponse<TsenderId = unknown, Texpand = unknown> = Required<ChatMessagesSenderKPIRecord<TsenderId>> & BaseSystemFields<Texpand>
export type ChatRoomsResponse<Texpand = unknown> = Required<ChatRoomsRecord> & BaseSystemFields<Texpand>
export type ChatRoomsOrderRelatedKPIResponse<Texpand = unknown> = Required<ChatRoomsOrderRelatedKPIRecord> & BaseSystemFields<Texpand>
export type ChatRoomsOverallKPIResponse<Texpand = unknown> = Required<ChatRoomsOverallKPIRecord> & BaseSystemFields<Texpand>
export type ChatRoomsTypeKPIResponse<Ttype = unknown, Texpand = unknown> = Required<ChatRoomsTypeKPIRecord<Ttype>> & BaseSystemFields<Texpand>
export type CompaniesResponse<Texpand = unknown> = Required<CompaniesRecord> & BaseSystemFields<Texpand>
export type CompaniesOverallKPIResponse<Texpand = unknown> = Required<CompaniesOverallKPIRecord> & BaseSystemFields<Texpand>
export type CompaniesTypeKPIResponse<Texpand = unknown> = Required<CompaniesTypeKPIRecord> & BaseSystemFields<Texpand>
export type DepartmentsResponse<Texpand = unknown> = Required<DepartmentsRecord> & BaseSystemFields<Texpand>
export type DepartmentsManagerEmployeeCountKPIResponse<Texpand = unknown> = Required<DepartmentsManagerEmployeeCountKPIRecord> & BaseSystemFields<Texpand>
export type DepartmentsOverallKPIResponse<Texpand = unknown> = Required<DepartmentsOverallKPIRecord> & BaseSystemFields<Texpand>
export type InventoryItemsResponse<Texpand = unknown> = Required<InventoryItemsRecord> & BaseSystemFields<Texpand>
export type InventoryItemsExpiryKPIResponse<TquantityExpiringSoon = unknown, Texpand = unknown> = Required<InventoryItemsExpiryKPIRecord<TquantityExpiringSoon>> & BaseSystemFields<Texpand>
export type InventoryItemsOverallKPIResponse<TtotalQuantityOnHandAllProducts = unknown, Texpand = unknown> = Required<InventoryItemsOverallKPIRecord<TtotalQuantityOnHandAllProducts>> & BaseSystemFields<Texpand>
export type InventoryItemsProductKPIResponse<TproductId = unknown, TtotalQuantityforProduct = unknown, Texpand = unknown> = Required<InventoryItemsProductKPIRecord<TproductId, TtotalQuantityforProduct>> & BaseSystemFields<Texpand>
export type InventoryItemsStatusKPIResponse<TquantityByStatus = unknown, Tstatus = unknown, Texpand = unknown> = Required<InventoryItemsStatusKPIRecord<TquantityByStatus, Tstatus>> & BaseSystemFields<Texpand>
export type InventoryItemsWarehouseKPIResponse<TtotalQuantityInWarehouse = unknown, TwarehouseId = unknown, Texpand = unknown> = Required<InventoryItemsWarehouseKPIRecord<TtotalQuantityInWarehouse, TwarehouseId>> & BaseSystemFields<Texpand>
export type InvoicesResponse<Texpand = unknown> = Required<InvoicesRecord> & BaseSystemFields<Texpand>
export type InvoicesCustomerKPIResponse<TtotalInvoicedToCustomer = unknown, Texpand = unknown> = Required<InvoicesCustomerKPIRecord<TtotalInvoicedToCustomer>> & BaseSystemFields<Texpand>
export type InvoicesOverallKPIResponse<TtotalAmountFromPaidInvoice = unknown, TtotalInvoiceAmount = unknown, TtotalOverdueAmount = unknown, Texpand = unknown> = Required<InvoicesOverallKPIRecord<TtotalAmountFromPaidInvoice, TtotalInvoiceAmount, TtotalOverdueAmount>> & BaseSystemFields<Texpand>
export type InvoicesStatusKPIResponse<TtotalAmountForStatus = unknown, Texpand = unknown> = Required<InvoicesStatusKPIRecord<TtotalAmountForStatus>> & BaseSystemFields<Texpand>
export type NotificationsResponse<Texpand = unknown> = Required<NotificationsRecord> & BaseSystemFields<Texpand>
export type NotificationsOverallKPIResponse<Texpand = unknown> = Required<NotificationsOverallKPIRecord> & BaseSystemFields<Texpand>
export type NotificationsPriorityKPIResponse<Texpand = unknown> = Required<NotificationsPriorityKPIRecord> & BaseSystemFields<Texpand>
export type NotificationsTypeKPIResponse<Texpand = unknown> = Required<NotificationsTypeKPIRecord> & BaseSystemFields<Texpand>
export type NotificationsUnreadKPIResponse<Texpand = unknown> = Required<NotificationsUnreadKPIRecord> & BaseSystemFields<Texpand>
export type OrderLineItemsResponse<Texpand = unknown> = Required<OrderLineItemsRecord> & BaseSystemFields<Texpand>
export type OrderLineItemsOverallKPIResponse<TaveragePricePerUnit = unknown, TaverageQuantityPerLine = unknown, TtotalQuantitySold = unknown, TtotalSubtotalRevenue = unknown, Texpand = unknown> = Required<OrderLineItemsOverallKPIRecord<TaveragePricePerUnit, TaverageQuantityPerLine, TtotalQuantitySold, TtotalSubtotalRevenue>> & BaseSystemFields<Texpand>
export type OrderLineItemsRevenueResponse<TproductId = unknown, TrevenuePerProduct = unknown, Texpand = unknown> = Required<OrderLineItemsRevenueRecord<TproductId, TrevenuePerProduct>> & BaseSystemFields<Texpand>
export type OrderLineItemsTopSellingKPIResponse<TproductId = unknown, TtotalQuantitySold = unknown, TtotalRevenueFromProduct = unknown, Texpand = unknown> = Required<OrderLineItemsTopSellingKPIRecord<TproductId, TtotalQuantitySold, TtotalRevenueFromProduct>> & BaseSystemFields<Texpand>
export type OrdersResponse<Texpand = unknown> = Required<OrdersRecord> & BaseSystemFields<Texpand>
export type OrdersCustomerKPIResponse<TtotalSpentByCustomer = unknown, Texpand = unknown> = Required<OrdersCustomerKPIRecord<TtotalSpentByCustomer>> & BaseSystemFields<Texpand>
export type OrdersMonthlyKPIResponse<TmontlyRevenue = unknown, TyearMonth = unknown, Texpand = unknown> = Required<OrdersMonthlyKPIRecord<TmontlyRevenue, TyearMonth>> & BaseSystemFields<Texpand>
export type OrdersOverallKPIResponse<TaverageOrderValue = unknown, TtotalRevenueFromOrders = unknown, Texpand = unknown> = Required<OrdersOverallKPIRecord<TaverageOrderValue, TtotalRevenueFromOrders>> & BaseSystemFields<Texpand>
export type OrdersStatusKPIResponse<TtotalAmountPerStatus = unknown, Texpand = unknown> = Required<OrdersStatusKPIRecord<TtotalAmountPerStatus>> & BaseSystemFields<Texpand>
export type PaymentsResponse<Texpand = unknown> = Required<PaymentsRecord> & BaseSystemFields<Texpand>
export type PaymentsMethodsKPIResponse<TtotalAmountByMethod = unknown, Texpand = unknown> = Required<PaymentsMethodsKPIRecord<TtotalAmountByMethod>> & BaseSystemFields<Texpand>
export type PaymentsOverallKPIResponse<TaveragePaymentAmount = unknown, TtotalAmountPaid = unknown, Texpand = unknown> = Required<PaymentsOverallKPIRecord<TaveragePaymentAmount, TtotalAmountPaid>> & BaseSystemFields<Texpand>
export type PaymentsStatusKPIResponse<Ttotal_amount_for_status = unknown, Texpand = unknown> = Required<PaymentsStatusKPIRecord<Ttotal_amount_for_status>> & BaseSystemFields<Texpand>
export type ProductsResponse<Texpand = unknown> = Required<ProductsRecord> & BaseSystemFields<Texpand>
export type ProductsOverallKPIResponse<TaverageProductCost = unknown, Texpand = unknown> = Required<ProductsOverallKPIRecord<TaverageProductCost>> & BaseSystemFields<Texpand>
export type ProductsSupplierKPIResponse<Texpand = unknown> = Required<ProductsSupplierKPIRecord> & BaseSystemFields<Texpand>
export type RouteSegmentsResponse<Texpand = unknown> = Required<RouteSegmentsRecord> & BaseSystemFields<Texpand>
export type RouteSegmentsAverageTimeKPIResponse<TavgDurationMinutesAtSegment = unknown, TsegmentType = unknown, Texpand = unknown> = Required<RouteSegmentsAverageTimeKPIRecord<TavgDurationMinutesAtSegment, TsegmentType>> & BaseSystemFields<Texpand>
export type RouteSegmentsDelaysKPIResponse<TsegmentType = unknown, Texpand = unknown> = Required<RouteSegmentsDelaysKPIRecord<TsegmentType>> & BaseSystemFields<Texpand>
export type RouteSegmentsOverallKPIResponse<Texpand = unknown> = Required<RouteSegmentsOverallKPIRecord> & BaseSystemFields<Texpand>
export type RouteSegmentsTypeKPIResponse<TsegmentType = unknown, Texpand = unknown> = Required<RouteSegmentsTypeKPIRecord<TsegmentType>> & BaseSystemFields<Texpand>
export type RoutesResponse<Texpand = unknown> = Required<RoutesRecord> & BaseSystemFields<Texpand>
export type RoutesDriverKPIResponse<Texpand = unknown> = Required<RoutesDriverKPIRecord> & BaseSystemFields<Texpand>
export type RoutesOverallKPIResponse<Texpand = unknown> = Required<RoutesOverallKPIRecord> & BaseSystemFields<Texpand>
export type RoutesStatusKPIResponse<Texpand = unknown> = Required<RoutesStatusKPIRecord> & BaseSystemFields<Texpand>
export type RoutesVehicleKPIResponse<Texpand = unknown> = Required<RoutesVehicleKPIRecord> & BaseSystemFields<Texpand>
export type ShipmentsResponse<Texpand = unknown> = Required<ShipmentsRecord> & BaseSystemFields<Texpand>
export type ShipmentsCarrierKPIResponse<Texpand = unknown> = Required<ShipmentsCarrierKPIRecord> & BaseSystemFields<Texpand>
export type ShipmentsDriverKPIResponse<Texpand = unknown> = Required<ShipmentsDriverKPIRecord> & BaseSystemFields<Texpand>
export type ShipmentsOnTimeDeliveryKPIResponse<TonTimeDeliveryPercentage = unknown, TonTimeShipments = unknown, Texpand = unknown> = Required<ShipmentsOnTimeDeliveryKPIRecord<TonTimeDeliveryPercentage, TonTimeShipments>> & BaseSystemFields<Texpand>
export type ShipmentsOverallKPIResponse<Texpand = unknown> = Required<ShipmentsOverallKPIRecord> & BaseSystemFields<Texpand>
export type ShipmentsStatusKPIResponse<Texpand = unknown> = Required<ShipmentsStatusKPIRecord> & BaseSystemFields<Texpand>
export type TaskMessagesResponse<Texpand = unknown> = Required<TaskMessagesRecord> & BaseSystemFields<Texpand>
export type TaskMessagesCountKPIResponse<TtaskId = unknown, Texpand = unknown> = Required<TaskMessagesCountKPIRecord<TtaskId>> & BaseSystemFields<Texpand>
export type TaskMessagesOverallKPIResponse<Texpand = unknown> = Required<TaskMessagesOverallKPIRecord> & BaseSystemFields<Texpand>
export type TasksResponse<Texpand = unknown> = Required<TasksRecord> & BaseSystemFields<Texpand>
export type TasksDepartmentKPIResponse<Texpand = unknown> = Required<TasksDepartmentKPIRecord> & BaseSystemFields<Texpand>
export type TasksOverallKPIResponse<Texpand = unknown> = Required<TasksOverallKPIRecord> & BaseSystemFields<Texpand>
export type TasksPriorityKPIResponse<Texpand = unknown> = Required<TasksPriorityKPIRecord> & BaseSystemFields<Texpand>
export type TasksSpecificTagKPIResponse<Ttagname = unknown, Texpand = unknown> = Required<TasksSpecificTagKPIRecord<Ttagname>> & BaseSystemFields<Texpand>
export type TasksStatusKPIResponse<Texpand = unknown> = Required<TasksStatusKPIRecord> & BaseSystemFields<Texpand>
export type UserAccessResponse<Texpand = unknown> = Required<UserAccessRecord> & BaseSystemFields<Texpand>
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> & AuthSystemFields<Texpand>
export type UsersCompanyKPIResponse<Texpand = unknown> = Required<UsersCompanyKPIRecord> & BaseSystemFields<Texpand>
export type UsersDepartmentKPIResponse<Texpand = unknown> = Required<UsersDepartmentKPIRecord> & BaseSystemFields<Texpand>
export type UsersOverallKPIResponse<Texpand = unknown> = Required<UsersOverallKPIRecord> & BaseSystemFields<Texpand>
export type UsersRoleKPIResponse<Texpand = unknown> = Required<UsersRoleKPIRecord> & BaseSystemFields<Texpand>
export type VehiclesResponse<Texpand = unknown> = Required<VehiclesRecord> & BaseSystemFields<Texpand>
export type VehiclesOverallKPIResponse<TaverageVolumeCapacity = unknown, TaverageWeightCapacity = unknown, Texpand = unknown> = Required<VehiclesOverallKPIRecord<TaverageVolumeCapacity, TaverageWeightCapacity>> & BaseSystemFields<Texpand>
export type VehiclesStatusKPIResponse<Texpand = unknown> = Required<VehiclesStatusKPIRecord> & BaseSystemFields<Texpand>
export type VehiclesTypeKPIResponse<Texpand = unknown> = Required<VehiclesTypeKPIRecord> & BaseSystemFields<Texpand>
export type WarehousesResponse<Texpand = unknown> = Required<WarehousesRecord> & BaseSystemFields<Texpand>
export type WarehousesManagerKPIResponse<Texpand = unknown> = Required<WarehousesManagerKPIRecord> & BaseSystemFields<Texpand>
export type WarehousesOverallKPIResponse<Texpand = unknown> = Required<WarehousesOverallKPIRecord> & BaseSystemFields<Texpand>
...
export type TypedPocketBase = PocketBase & {
	...
	collection(idOrName: 'chatMessagesOverallKPI'): RecordService<ChatMessagesOverallKPIResponse>
	collection(idOrName: 'chatMessagesPerRoomKPI'): RecordService<ChatMessagesPerRoomKPIResponse>
	collection(idOrName: 'chatMessagesSenderKPI'): RecordService<ChatMessagesSenderKPIResponse>
	collection(idOrName: 'chatRooms'): RecordService<ChatRoomsResponse>
	collection(idOrName: 'chatRoomsOrderRelatedKPI'): RecordService<ChatRoomsOrderRelatedKPIResponse>
	collection(idOrName: 'chatRoomsOverallKPI'): RecordService<ChatRoomsOverallKPIResponse>
	collection(idOrName: 'chatRoomsTypeKPI'): RecordService<ChatRoomsTypeKPIResponse>
	collection(idOrName: 'companies'): RecordService<CompaniesResponse>
	collection(idOrName: 'companiesOverallKPI'): RecordService<CompaniesOverallKPIResponse>
	collection(idOrName: 'companiesTypeKPI'): RecordService<CompaniesTypeKPIResponse>
	collection(idOrName: 'departments'): RecordService<DepartmentsResponse>
	collection(idOrName: 'departmentsManagerEmployeeCountKPI'): RecordService<DepartmentsManagerEmployeeCountKPIResponse>
	collection(idOrName: 'departmentsOverallKPI'): RecordService<DepartmentsOverallKPIResponse>
	collection(idOrName: 'inventoryItems'): RecordService<InventoryItemsResponse>
	collection(idOrName: 'inventoryItemsExpiryKPI'): RecordService<InventoryItemsExpiryKPIResponse>
	collection(idOrName: 'inventoryItemsOverallKPI'): RecordService<InventoryItemsOverallKPIResponse>
	collection(idOrName: 'inventoryItemsProductKPI'): RecordService<InventoryItemsProductKPIResponse>
	collection(idOrName: 'inventoryItemsStatusKPI'): RecordService<InventoryItemsStatusKPIResponse>
	collection(idOrName: 'inventoryItemsWarehouseKPI'): RecordService<InventoryItemsWarehouseKPIResponse>
	collection(idOrName: 'invoices'): RecordService<InvoicesResponse>
	collection(idOrName: 'invoicesCustomerKPI'): RecordService<InvoicesCustomerKPIResponse>
	collection(idOrName: 'invoicesOverallKPI'): RecordService<InvoicesOverallKPIResponse>
	collection(idOrName: 'invoicesStatusKPI'): RecordService<InvoicesStatusKPIResponse>
	collection(idOrName: 'notifications'): RecordService<NotificationsResponse>
	collection(idOrName: 'notificationsOverallKPI'): RecordService<NotificationsOverallKPIResponse>
	collection(idOrName: 'notificationsPriorityKPI'): RecordService<NotificationsPriorityKPIResponse>
	collection(idOrName: 'notificationsTypeKPI'): RecordService<NotificationsTypeKPIResponse>
	collection(idOrName: 'notificationsUnreadKPI'): RecordService<NotificationsUnreadKPIResponse>
	collection(idOrName: 'orderLineItems'): RecordService<OrderLineItemsResponse>
	collection(idOrName: 'orderLineItemsOverallKPI'): RecordService<OrderLineItemsOverallKPIResponse>
	collection(idOrName: 'orderLineItemsRevenue'): RecordService<OrderLineItemsRevenueResponse>
	collection(idOrName: 'orderLineItemsTopSellingKPI'): RecordService<OrderLineItemsTopSellingKPIResponse>
	collection(idOrName: 'orders'): RecordService<OrdersResponse>
	collection(idOrName: 'ordersCustomerKPI'): RecordService<OrdersCustomerKPIResponse>
	collection(idOrName: 'ordersMonthlyKPI'): RecordService<OrdersMonthlyKPIResponse>
	collection(idOrName: 'ordersOverallKPI'): RecordService<OrdersOverallKPIResponse>
	collection(idOrName: 'ordersStatusKPI'): RecordService<OrdersStatusKPIResponse>
	collection(idOrName: 'payments'): RecordService<PaymentsResponse>
	collection(idOrName: 'paymentsMethodsKPI'): RecordService<PaymentsMethodsKPIResponse>
	collection(idOrName: 'paymentsOverallKPI'): RecordService<PaymentsOverallKPIResponse>
	collection(idOrName: 'paymentsStatusKPI'): RecordService<PaymentsStatusKPIResponse>
	collection(idOrName: 'products'): RecordService<ProductsResponse>
	collection(idOrName: 'productsOverallKPI'): RecordService<ProductsOverallKPIResponse>
	collection(idOrName: 'productsSupplierKPI'): RecordService<ProductsSupplierKPIResponse>
	collection(idOrName: 'routeSegments'): RecordService<RouteSegmentsResponse>
	collection(idOrName: 'routeSegmentsAverageTimeKPI'): RecordService<RouteSegmentsAverageTimeKPIResponse>
	collection(idOrName: 'routeSegmentsDelaysKPI'): RecordService<RouteSegmentsDelaysKPIResponse>
	collection(idOrName: 'routeSegmentsOverallKPI'): RecordService<RouteSegmentsOverallKPIResponse>
	collection(idOrName: 'routeSegmentsTypeKPI'): RecordService<RouteSegmentsTypeKPIResponse>
	collection(idOrName: 'routes'): RecordService<RoutesResponse>
	collection(idOrName: 'routesDriverKPI'): RecordService<RoutesDriverKPIResponse>
	collection(idOrName: 'routesOverallKPI'): RecordService<RoutesOverallKPIResponse>
	collection(idOrName: 'routesStatusKPI'): RecordService<RoutesStatusKPIResponse>
	collection(idOrName: 'routesVehicleKPI'): RecordService<RoutesVehicleKPIResponse>
	collection(idOrName: 'shipments'): RecordService<ShipmentsResponse>
	collection(idOrName: 'shipmentsCarrierKPI'): RecordService<ShipmentsCarrierKPIResponse>
	collection(idOrName: 'shipmentsDriverKPI'): RecordService<ShipmentsDriverKPIResponse>
	collection(idOrName: 'shipmentsOnTimeDeliveryKPI'): RecordService<ShipmentsOnTimeDeliveryKPIResponse>
	collection(idOrName: 'shipmentsOverallKPI'): RecordService<ShipmentsOverallKPIResponse>
	collection(idOrName: 'shipmentsStatusKPI'): RecordService<ShipmentsStatusKPIResponse>
	collection(idOrName: 'taskMessages'): RecordService<TaskMessagesResponse>
	collection(idOrName: 'taskMessagesCountKPI'): RecordService<TaskMessagesCountKPIResponse>
	collection(idOrName: 'taskMessagesOverallKPI'): RecordService<TaskMessagesOverallKPIResponse>
	collection(idOrName: 'tasks'): RecordService<TasksResponse>
	collection(idOrName: 'tasksDepartmentKPI'): RecordService<TasksDepartmentKPIResponse>
	collection(idOrName: 'tasksOverallKPI'): RecordService<TasksOverallKPIResponse>
	collection(idOrName: 'tasksPriorityKPI'): RecordService<TasksPriorityKPIResponse>
	collection(idOrName: 'tasksSpecificTagKPI'): RecordService<TasksSpecificTagKPIResponse>
	...
	collection(idOrName: 'usersCompanyKPI'): RecordService<UsersCompanyKPIResponse>
	collection(idOrName: 'usersDepartmentKPI'): RecordService<UsersDepartmentKPIResponse>
	collection(idOrName: 'usersOverallKPI'): RecordService<UsersOverallKPIResponse>
	...
	collection(idOrName: 'vehiclesOverallKPI'): RecordService<VehiclesOverallKPIResponse>
	collection(idOrName: 'vehiclesStatusKPI'): RecordService<VehiclesStatusKPIResponse>
	collection(idOrName: 'vehiclesTypeKPI'): RecordService<VehiclesTypeKPIResponse>
	collection(idOrName: 'warehouses'): RecordService<WarehousesResponse>
	collection(idOrName: 'warehousesManagerKPI'): RecordService<WarehousesManagerKPIResponse>
	collection(idOrName: 'warehousesOverallKPI'): RecordService<WarehousesOverallKPIResponse>
}
