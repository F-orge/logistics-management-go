...
const billingPaginateAccountingSyncLogMetadata = `-- name: BillingPaginateAccountingSyncLogMetadata :one
select
...
type BillingPaginateAccountingSyncLogMetadataParams struct {
	PerPage int32 `db:"per_page" json:"per_page"`
	Page    int32 `db:"page" json:"page"`
}

type BillingPaginateAccountingSyncLogMetadataRow struct {
...
func (q *Queries) BillingPaginateAccountingSyncLogMetadata(ctx context.Context, arg BillingPaginateAccountingSyncLogMetadataParams) (BillingPaginateAccountingSyncLogMetadataRow, error) {
	row := q.db.QueryRow(ctx, billingPaginateAccountingSyncLogMetadata, arg.PerPage, arg.Page)
	var i BillingPaginateAccountingSyncLogMetadataRow
	err := row.Scan(
		&i.TotalItems,
		&i.TotalPages,
		&i.Page,
