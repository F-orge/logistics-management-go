...
const wmsPaginateSalesOrderMetadata = `-- name: WmsPaginateSalesOrderMetadata :one
select
...
type WmsPaginateSalesOrderMetadataParams struct {
	PerPage int32 `db:"per_page" json:"per_page"`
	Page    int32 `db:"page" json:"page"`
}

type WmsPaginateSalesOrderMetadataRow struct {
...
func (q *Queries) WmsPaginateSalesOrderMetadata(ctx context.Context, arg WmsPaginateSalesOrderMetadataParams) (WmsPaginateSalesOrderMetadataRow, error) {
	row := q.db.QueryRow(ctx, wmsPaginateSalesOrderMetadata, arg.PerPage, arg.Page)
	var i WmsPaginateSalesOrderMetadataRow
	err := row.Scan(
		&i.TotalItems,
		&i.TotalPages,
		&i.Page,
