...
const wmsPaginateLocationMetadata = `-- name: WmsPaginateLocationMetadata :one
select
...
type WmsPaginateLocationMetadataParams struct {
	PerPage int32       `db:"per_page" json:"per_page"`
	Page    int32       `db:"page" json:"page"`
	Search  pgtype.Text `db:"search" json:"search"`
}

type WmsPaginateLocationMetadataRow struct {
...
func (q *Queries) WmsPaginateLocationMetadata(ctx context.Context, arg WmsPaginateLocationMetadataParams) (WmsPaginateLocationMetadataRow, error) {
	row := q.db.QueryRow(ctx, wmsPaginateLocationMetadata, arg.PerPage, arg.Page, arg.Search)
	var i WmsPaginateLocationMetadataRow
	err := row.Scan(
		&i.TotalItems,
		&i.TotalPages,
		&i.Page,
