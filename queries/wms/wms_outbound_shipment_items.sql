...
set
  updated_at = now(),
  outbound_shipment_id = case when sqlc.arg(set_outbound_shipment_id)::boolean then
    sqlc.arg(outbound_shipment_id)::uuid
  else
    outbound_shipment_id
  end,
  sales_order_item_id = case when sqlc.arg(set_sales_order_item_id)::boolean then
  ...
  quantity_shipped = case when sqlc.arg(set_quantity_shipped)::boolean then
