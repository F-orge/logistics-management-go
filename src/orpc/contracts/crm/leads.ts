...
export const inLeadContract = oc.input(z.array(z.uuid()).nonempty()).output(z.array(crmLeadSchema))

export const createLeadContract = oc.input(crmLeadInsertSchema).output(crmLeadSchema)
