...
import { wmsReturnInsertSchema, wmsReturnSchema, wmsReturnUpdateSchema } from '@/schemas/wms/return'
...
export const createReturnContract = oc.input(wmsReturnInsertSchema).output(wmsReturnSchema)
