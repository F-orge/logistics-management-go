...
export const paginateStockTransfer = implement(wmsContracts.paginateStockTransferContract)
...
export const rangeStockTransfer = implement(wmsContracts.rangeStockTransferContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new StockTransferRepository(context.db)
...
export const createStockTransfer = implement(wmsContracts.createStockTransferContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new StockTransferRepository(context.db)
...
export const updateStockTransfer = implement(wmsContracts.updateStockTransferContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new StockTransferRepository(context.db)
...
export const deleteStockTransfer = implement(wmsContracts.deleteStockTransferContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new StockTransferRepository(context.db)
