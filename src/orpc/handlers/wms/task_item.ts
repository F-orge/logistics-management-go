...
export const paginateTaskItem = implement(wmsContracts.paginateTaskItemContract)
  ...
  .handler(async ({ context, input }) => {
    const repo = new WmsTaskItemRepository(context.db);
...
export const createTaskItem = implement(
  wmsContracts.createTaskItemContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsTaskItemRepository(context.db);
...
export const updateTaskItem = implement(
  wmsContracts.updateTaskItemContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsTaskItemRepository(context.db);
...
export const deleteTaskItem = implement(
  wmsContracts.deleteTaskItemContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsTaskItemRepository(context.db);
