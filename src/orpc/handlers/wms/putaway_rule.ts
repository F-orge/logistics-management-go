...
export const paginatePutawayRule = implement(wmsContracts.paginatePutawayRuleContract)
...
export const createPutawayRule = implement(wmsContracts.createPutawayRuleContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PutawayRuleRepository(context.db)
...
export const updatePutawayRule = implement(wmsContracts.updatePutawayRuleContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PutawayRuleRepository(context.db)
...
export const deletePutawayRule = implement(wmsContracts.deletePutawayRuleContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PutawayRuleRepository(context.db)
