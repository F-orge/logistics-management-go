...
export const paginatePutawayRule = implement(
  ...
  .handler(async ({ context, input }) => {
    const repo = new WmsPutawayRuleRepository(context.db);
...
export const rangePutawayRule = implement(
  wmsContracts.rangePutawayRuleContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsPutawayRuleRepository(context.db);
...
export const inPutawayRule = implement(
  wmsContracts.inPutawayRuleContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsPutawayRuleRepository(context.db);
