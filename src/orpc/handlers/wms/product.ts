...
export const paginateProduct = implement(wmsContracts.paginateProductContract)
  ...
  .handler(async ({ context, input }) => {
    const repo = new WmsProductRepository(context.db);
...
export const updateProduct = implement(
  wmsContracts.updateProductContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsProductRepository(context.db);
...
export const deleteProduct = implement(
  wmsContracts.deleteProductContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsProductRepository(context.db);
