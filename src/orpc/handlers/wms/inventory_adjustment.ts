...
export const rangeInventoryAdjustment = implement(wmsContracts.rangeInventoryAdjustmentContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InventoryAdjustmentRepository(context.db)
...
export const inInventoryAdjustment = implement(wmsContracts.inInventoryAdjustmentContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InventoryAdjustmentRepository(context.db)
...
export const createInventoryAdjustment = implement(wmsContracts.createInventoryAdjustmentContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InventoryAdjustmentRepository(context.db)
...
export const updateInventoryAdjustment = implement(wmsContracts.updateInventoryAdjustmentContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InventoryAdjustmentRepository(context.db)
...
export const deleteInventoryAdjustment = implement(wmsContracts.deleteInventoryAdjustmentContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InventoryAdjustmentRepository(context.db)
