...
export const paginatePickBatchItem = implement(wmsContracts.paginatePickBatchItemContract)
...
export const rangePickBatchItem = implement(wmsContracts.rangePickBatchItemContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PickBatchItemRepository(context.db)
...
export const createPickBatchItem = implement(wmsContracts.createPickBatchItemContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PickBatchItemRepository(context.db)
...
export const updatePickBatchItem = implement(wmsContracts.updatePickBatchItemContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PickBatchItemRepository(context.db)
...
export const deletePickBatchItem = implement(wmsContracts.deletePickBatchItemContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PickBatchItemRepository(context.db)
