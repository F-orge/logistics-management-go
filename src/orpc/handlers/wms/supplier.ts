...
export const paginateSupplier = implement(wmsContracts.paginateSupplierContract)
  ...
  .handler(async ({ context, input }) => {
    const repo = new WmsSupplierRepository(context.db);
...
export const updateSupplier = implement(
  wmsContracts.updateSupplierContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsSupplierRepository(context.db);
...
export const deleteSupplier = implement(
  wmsContracts.deleteSupplierContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsSupplierRepository(context.db);
