...
export const paginateReturn = implement(wmsContracts.paginateReturnContract)
  ...
  .handler(async ({ context, input }) => {
    const repo = new WmsReturnRepository(context.db);
...
export const updateReturn = implement(
  wmsContracts.updateReturnContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsReturnRepository(context.db);
...
export const deleteReturn = implement(
  wmsContracts.deleteReturnContract,
)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new WmsReturnRepository(context.db);
