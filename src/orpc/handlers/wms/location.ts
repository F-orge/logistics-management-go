...
import * as wmsContracts from '@/orpc/contracts/wms/location'
import { LocationRepository } from '@/repositories/wms/locations'
...
export const paginateLocation = implement(wmsContracts.paginateLocationContract)
  ...
  .handler(async ({ context, input }) => {
    const repo = new LocationRepository(context.db)
