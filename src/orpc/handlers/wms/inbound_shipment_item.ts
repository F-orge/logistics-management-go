...
export const rangeInboundShipmentItem = implement(wmsContracts.rangeInboundShipmentItemContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InboundShipmentItemRepository(context.db)
...
export const inInboundShipmentItem = implement(wmsContracts.inInboundShipmentItemContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InboundShipmentItemRepository(context.db)
...
export const createInboundShipmentItem = implement(wmsContracts.createInboundShipmentItemContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InboundShipmentItemRepository(context.db)
...
export const updateInboundShipmentItem = implement(wmsContracts.updateInboundShipmentItemContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InboundShipmentItemRepository(context.db)
...
export const deleteInboundShipmentItem = implement(wmsContracts.deleteInboundShipmentItemContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new InboundShipmentItemRepository(context.db)
