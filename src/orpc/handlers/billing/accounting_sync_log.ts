...
export const rangeAccountingSyncLog = implement(billingContracts.rangeAccountingSyncLogContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountingSyncLogRepository(context.db)
...
export const inAccountingSyncLog = implement(billingContracts.inAccountingSyncLogContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountingSyncLogRepository(context.db)
...
export const createAccountingSyncLog = implement(billingContracts.createAccountingSyncLogContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountingSyncLogRepository(context.db)
...
export const updateAccountingSyncLog = implement(billingContracts.updateAccountingSyncLogContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountingSyncLogRepository(context.db)
...
export const deleteAccountingSyncLog = implement(billingContracts.deleteAccountingSyncLogContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountingSyncLogRepository(context.db)
