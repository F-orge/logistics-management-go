...
export const rangeAccountTransaction = implement(billingContracts.rangeAccountTransactionContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountTransactionRepository(context.db)
...
export const inAccountTransaction = implement(billingContracts.inAccountTransactionContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountTransactionRepository(context.db)
...
export const createAccountTransaction = implement(billingContracts.createAccountTransactionContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountTransactionRepository(context.db)
...
export const updateAccountTransaction = implement(billingContracts.updateAccountTransactionContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountTransactionRepository(context.db)
...
export const deleteAccountTransaction = implement(billingContracts.deleteAccountTransactionContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new AccountTransactionRepository(context.db)
