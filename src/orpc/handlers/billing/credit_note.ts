...
export const paginateCreditNote = implement(billingContracts.paginateCreditNoteContract)
...
export const rangeCreditNote = implement(billingContracts.rangeCreditNoteContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new CreditNoteRepository(context.db)
...
export const createCreditNote = implement(billingContracts.createCreditNoteContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new CreditNoteRepository(context.db)
...
export const updateCreditNote = implement(billingContracts.updateCreditNoteContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new CreditNoteRepository(context.db)
...
export const deleteCreditNote = implement(billingContracts.deleteCreditNoteContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new CreditNoteRepository(context.db)
