...
export const paginateSurcharge = implement(billingContracts.paginateSurchargeContract)
...
export const createSurcharge = implement(billingContracts.createSurchargeContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new SurchargeRepository(context.db)
...
export const updateSurcharge = implement(billingContracts.updateSurchargeContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new SurchargeRepository(context.db)
...
export const deleteSurcharge = implement(billingContracts.deleteSurchargeContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new SurchargeRepository(context.db)
