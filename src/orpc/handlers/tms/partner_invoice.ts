...
export const paginatePartnerInvoice = implement(tmsContracts.paginatePartnerInvoiceContract)
...
export const rangePartnerInvoice = implement(tmsContracts.rangePartnerInvoiceContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PartnerInvoiceRepository(context.db)
...
export const createPartnerInvoice = implement(tmsContracts.createPartnerInvoiceContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PartnerInvoiceRepository(context.db)
...
export const updatePartnerInvoice = implement(tmsContracts.updatePartnerInvoiceContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PartnerInvoiceRepository(context.db)
...
export const deletePartnerInvoice = implement(tmsContracts.deletePartnerInvoiceContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new PartnerInvoiceRepository(context.db)
