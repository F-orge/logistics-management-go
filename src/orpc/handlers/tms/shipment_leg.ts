...
export const paginateShipmentLeg = implement(tmsContracts.paginateShipmentLegContract)
...
export const createShipmentLeg = implement(tmsContracts.createShipmentLegContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new ShipmentLegRepository(context.db)
...
export const updateShipmentLeg = implement(tmsContracts.updateShipmentLegContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new ShipmentLegRepository(context.db)
...
export const deleteShipmentLeg = implement(tmsContracts.deleteShipmentLegContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new ShipmentLegRepository(context.db)
