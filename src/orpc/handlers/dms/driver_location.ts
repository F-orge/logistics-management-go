...
export const paginateDriverLocation = implement(dmsContracts.paginateDriverLocationContract)
...
export const rangeDriverLocation = implement(dmsContracts.rangeDriverLocationContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new DriverLocationRepository(context.db)
...
export const createDriverLocation = implement(dmsContracts.createDriverLocationContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new DriverLocationRepository(context.db)
...
export const updateDriverLocation = implement(dmsContracts.updateDriverLocationContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new DriverLocationRepository(context.db)
...
export const deleteDriverLocation = implement(dmsContracts.deleteDriverLocationContract)
  .$context<HonoVariables>()
  .handler(async ({ context, input }) => {
    const repo = new DriverLocationRepository(context.db)
