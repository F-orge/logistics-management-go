...
export type BillingManagementLogsRecord<TrequestPayload = unknown, TresponsePayload = unknown> = {
	created: IsoAutoDateString
	errorMessage?: string
	externalId?: string
...
export type BillingManagementLogsResponse<TrequestPayload = unknown, TresponsePayload = unknown, Texpand = unknown> = Required<BillingManagementLogsRecord<TrequestPayload, TresponsePayload>> & BaseSystemFields<Texpand>
