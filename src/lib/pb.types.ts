...
export enum BillingManagementAccountLogsStatusOptions {
	"pending" = "pending",
...
export type BillingManagementAccountLogsRecord<TrequestPayload = unknown, TresponsePayload = unknown> = {
	created: IsoAutoDateString
	errorMessage?: string
	externalId?: string
...
export type BillingManagementAccountLogsResponse<TrequestPayload = unknown, TresponsePayload = unknown, Texpand = unknown> = Required<BillingManagementAccountLogsRecord<TrequestPayload, TresponsePayload>> & BaseSystemFields<Texpand>
export type BillingManagementAccountTransactionsResponse<Texpand = unknown> = Required<BillingManagementAccountTransactionsRecord> & BaseSystemFields<Texpand>
export type BillingManagementClientAccountsResponse<Texpand = unknown> = Required<BillingManagementClientAccountsRecord> & BaseSystemFields<Texpand>
export type BillingManagementCreditNotesResponse<Texpand = unknown> = Required<BillingManagementCreditNotesRecord> & BaseSystemFields<Texpand>
export type BillingManagementDisputesResponse<Texpand = unknown> = Required<BillingManagementDisputesRecord> & BaseSystemFields<Texpand>
export type BillingManagementInvoiceLineItemsResponse<Texpand = unknown> = Required<BillingManagementInvoiceLineItemsRecord> & BaseSystemFields<Texpand>
export type BillingManagementInvoicesResponse<Texpand = unknown> = Required<BillingManagementInvoicesRecord> & BaseSystemFields<Texpand>
export type BillingManagementPaymentsResponse<Texpand = unknown> = Required<BillingManagementPaymentsRecord> & BaseSystemFields<Texpand>
export type BillingManagementQuotesResponse<Texpand = unknown> = Required<BillingManagementQuotesRecord> & BaseSystemFields<Texpand>
export type BillingManagementRateCardsResponse<Texpand = unknown> = Required<BillingManagementRateCardsRecord> & BaseSystemFields<Texpand>
export type BillingManagementRateRulesResponse<Texpand = unknown> = Required<BillingManagementRateRulesRecord> & BaseSystemFields<Texpand>
export type BillingManagementSurchargesResponse<Texpand = unknown> = Required<BillingManagementSurchargesRecord> & BaseSystemFields<Texpand>
export type CustomerRelationsCampaignsResponse<Texpand = unknown> = Required<CustomerRelationsCampaignsRecord> & BaseSystemFields<Texpand>
export type CustomerRelationsCasesResponse<Texpand = unknown> = Required<CustomerRelationsCasesRecord> & BaseSystemFields<Texpand>
export type CustomerRelationsCompaniesResponse<Texpand = unknown> = Required<CustomerRelationsCompaniesRecord> & BaseSystemFields<Texpand>
export type CustomerRelationsContactsResponse<Texpand = unknown> = Required<CustomerRelationsContactsRecord> & BaseSystemFields<Texpand>
export type CustomerRelationsInteractionsResponse<Texpand = unknown> = Required<CustomerRelationsInteractionsRecord> & BaseSystemFields<Texpand>
export type CustomerRelationsInvoiceItemsResponse<Texpand = unknown> = Required<CustomerRelationsInvoiceItemsRecord> & BaseSystemFields<Texpand>
export type CustomerRelationsInvoicesResponse<Texpand = unknown> = Required<CustomerRelationsInvoicesRecord> & BaseSystemFields<Texpand>
export type CustomerRelationsLeadsResponse<Texpand = unknown> = Required<CustomerRelationsLeadsRecord> & BaseSystemFields<Texpand>
export type CustomerRelationsOpportunitiesResponse<Texpand = unknown> = Required<CustomerRelationsOpportunitiesRecord> & BaseSystemFields<Texpand>
...
export type TransportManagementProofOfDeliveriesResponse<Texpand = unknown> = Required<TransportManagementProofOfDeliveriesRecord> & BaseSystemFields<Texpand>
export type TransportManagementRoutesResponse<Texpand = unknown> = Required<TransportManagementRoutesRecord> & BaseSystemFields<Texpand>
export type TransportManagementShipmentLegEventsResponse<Texpand = unknown> = Required<TransportManagementShipmentLegEventsRecord> & BaseSystemFields<Texpand>
export type TransportManagementShipmentLegsResponse<Texpand = unknown> = Required<TransportManagementShipmentLegsRecord> & BaseSystemFields<Texpand>
export type TransportManagementTripStopsResponse<Texpand = unknown> = Required<TransportManagementTripStopsRecord> & BaseSystemFields<Texpand>
export type TransportManagementTripsResponse<Texpand = unknown> = Required<TransportManagementTripsRecord> & BaseSystemFields<Texpand>
export type TransportManagementVehicleMaintenanceResponse<Texpand = unknown> = Required<TransportManagementVehicleMaintenanceRecord> & BaseSystemFields<Texpand>
export type TransportManagementVehiclesResponse<Texpand = unknown> = Required<TransportManagementVehiclesRecord> & BaseSystemFields<Texpand>
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> & AuthSystemFields<Texpand>
export type WarehouseManagementBinThresholdResponse<Texpand = unknown> = Required<WarehouseManagementBinThresholdRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementInboundShipmentItemsResponse<Texpand = unknown> = Required<WarehouseManagementInboundShipmentItemsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementInboundShipmentsResponse<Texpand = unknown> = Required<WarehouseManagementInboundShipmentsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementInventoryAdjustmentResponse<Texpand = unknown> = Required<WarehouseManagementInventoryAdjustmentRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementInventoryBatchesResponse<Texpand = unknown> = Required<WarehouseManagementInventoryBatchesRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementInventoryStockResponse<Texpand = unknown> = Required<WarehouseManagementInventoryStockRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementLocationsResponse<Texpand = unknown> = Required<WarehouseManagementLocationsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementOutboundShipmentItemsResponse<Texpand = unknown> = Required<WarehouseManagementOutboundShipmentItemsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementOutboundShipmentsResponse<Texpand = unknown> = Required<WarehouseManagementOutboundShipmentsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementPackageItemsResponse<Texpand = unknown> = Required<WarehouseManagementPackageItemsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementPackagesResponse<Texpand = unknown> = Required<WarehouseManagementPackagesRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementPickBatchItemsResponse<Texpand = unknown> = Required<WarehouseManagementPickBatchItemsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementPickBatchesResponse<Texpand = unknown> = Required<WarehouseManagementPickBatchesRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementProductsResponse<Texpand = unknown> = Required<WarehouseManagementProductsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementPutawayRulesResponse<Texpand = unknown> = Required<WarehouseManagementPutawayRulesRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementReorderPointsResponse<Texpand = unknown> = Required<WarehouseManagementReorderPointsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementReturnItemsResponse<Texpand = unknown> = Required<WarehouseManagementReturnItemsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementReturnsResponse<Texpand = unknown> = Required<WarehouseManagementReturnsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementSalesOrderItemsResponse<Texpand = unknown> = Required<WarehouseManagementSalesOrderItemsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementSalesOrdersResponse<Texpand = unknown> = Required<WarehouseManagementSalesOrdersRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementStockTransferResponse<Texpand = unknown> = Required<WarehouseManagementStockTransferRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementSuppliersResponse<Texpand = unknown> = Required<WarehouseManagementSuppliersRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementTaskItemsResponse<Texpand = unknown> = Required<WarehouseManagementTaskItemsRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementTasksResponse<Texpand = unknown> = Required<WarehouseManagementTasksRecord> & BaseSystemFields<Texpand>
export type WarehouseManagementWarehousesResponse<Texpand = unknown> = Required<WarehouseManagementWarehousesRecord> & BaseSystemFields<Texpand>
