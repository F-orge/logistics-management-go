...
export type BillingManagementAccountLogsRecord<
...
export type BillingManagementAccountLogsResponse<
	TrequestPayload = unknown,
	TresponsePayload = unknown,
	Texpand = unknown,
> = Required<
	BillingManagementAccountLogsRecord<TrequestPayload, TresponsePayload>
> &
	BaseSystemFields<Texpand>;
...
export type DeliveryManagementProofOfDeliveriesResponse<Texpand = unknown> =
	Required<DeliveryManagementProofOfDeliveriesRecord> &
		BaseSystemFields<Texpand>;
