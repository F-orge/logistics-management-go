...
export const columns: ColumnDef<ShipmentWithExpands>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      if (senderContact) {
        return <div>{senderContact.first_name} {senderContact.last_name}</div>;
      }
      return <div>-</div>;
    },
  },
  {
    ...
    cell: ({ row }) => {
      ...
      if (receiverContact) {
        return (
          <div>{receiverContact.first_name} {receiverContact.last_name}</div>
        );
      }
      return <div>-</div>;
    },
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div>{currency} {value.toFixed(2)}</div>;
    },
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div>{currency} {cost.toFixed(2)}</div>;
    },
  },
  {
