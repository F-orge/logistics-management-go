...
import {
  ...
  paginateOutboundShipment,
  rangeOutboundShipment,
} from '@/queries/wms/outbound_shipment'
...
export const Route = createFileRoute('/dashboard/wms/outbound-shipment/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(wmsOutboundShipmentSchema).default([
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateOutboundShipment(context.search)),
      chart: await context.queryClient.fetchQuery(rangeOutboundShipment({ from, to })),
    }
  },
})
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteOutboundShipment, queryClient)
