...
import {
  deleteStockTransfer,
  paginateStockTransfer,
  rangeStockTransfer,
} from '@/queries/wms/stock_transfer'
...
export const Route = createFileRoute('/dashboard/wms/stock-transfer/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(wmsStockTransferSchema).default([
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateStockTransfer(context.search)),
      chart: await context.queryClient.fetchQuery(rangeStockTransfer({ from, to })),
    }
  },
})
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteStockTransfer, queryClient)
