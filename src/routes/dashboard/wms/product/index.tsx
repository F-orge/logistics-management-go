...
export const Route = createFileRoute('/dashboard/wms/product/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(wmsProductSchema).default([{ column: 'createdAt', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateProduct(context.search)),
      chart: await context.queryClient.fetchQuery(rangeProduct({ from, to })),
    }
  },
})
