...
import { deleteLocation, paginateLocation, rangeLocation } from '@/queries/wms/location'
...
export const Route = createFileRoute('/dashboard/wms/location/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(wmsLocationSchema).default([{ column: 'createdAt', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateLocation(context.search)),
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteLocation, queryClient)
