...
import {
  ...
  paginateInventoryStock,
  rangeInventoryStock,
} from '@/queries/wms/inventory_stock'
...
export const Route = createFileRoute('/dashboard/wms/inventory-stock/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(wmsInventoryStockSchema).default([
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateInventoryStock(context.search)),
      chart: await context.queryClient.fetchQuery(rangeInventoryStock({ from, to })),
    }
  },
})
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteInventoryStock, queryClient)
