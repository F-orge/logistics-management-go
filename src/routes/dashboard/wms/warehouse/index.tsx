...
import { deleteWarehouse, paginateWarehouse, rangeWarehouse } from '@/queries/wms/warehouse'
...
export const Route = createFileRoute('/dashboard/wms/warehouse/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(wmsWarehouseSchema).default([{ column: 'createdAt', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateWarehouse(context.search)),
