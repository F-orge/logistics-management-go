...
export const Route = createFileRoute('/dashboard/crm/leads/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(crmLeadSchema).default([{ column: 'createdAt', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    const dataTable = await context.queryClient.fetchQuery(paginateLead(context.search))
