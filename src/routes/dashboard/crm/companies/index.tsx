...
import { deleteCompany, paginateCompany, rangeCompany } from '@/queries/crm/companies'
...
export const Route = createFileRoute('/dashboard/crm/companies/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(crmCompanySchema).default([{ column: 'createdAt', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateCompany(context.search)),
