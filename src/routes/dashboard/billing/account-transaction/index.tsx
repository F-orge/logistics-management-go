...
import {
  ...
  paginateAccountTransaction,
  rangeAccountTransaction,
} from '@/queries/billing/account_transaction'
...
export const Route = createFileRoute('/dashboard/billing/account-transaction/')({
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateAccountTransaction(context.search)),
      chart: await context.queryClient.fetchQuery(rangeAccountTransaction({ from, to })),
    }
  },
})
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteAccountTransaction, queryClient)
