...
import { deleteDispute, paginateDispute, rangeDispute } from '@/queries/billing/dispute'
...
export const Route = createFileRoute('/dashboard/billing/dispute/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(billingDisputeSchema).default([{ column: 'createdAt', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateDispute(context.search)),
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteDispute, queryClient)
