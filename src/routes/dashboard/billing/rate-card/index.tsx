...
import { deleteRateCard, paginateRateCard, rangeRateCard } from '@/queries/billing/rate_card'
...
export const Route = createFileRoute('/dashboard/billing/rate-card/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(billingRateCardSchema).default([
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateRateCard(context.search)),
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteRateCard, queryClient)
