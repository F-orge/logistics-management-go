...
export const Route = createFileRoute('/dashboard/dms/delivery-task/')({
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateDeliveryTask(context.search)),
      chart: await context.queryClient.fetchQuery(rangeDeliveryTask({ from, to })),
    }
  },
})
