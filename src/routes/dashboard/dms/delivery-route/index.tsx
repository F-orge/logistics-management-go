...
import {
  ...
  rangeDeliveryRoute,
} from '@/queries/dms/delivery_route'
...
export const Route = createFileRoute('/dashboard/dms/delivery-route/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(dmsDeliveryRouteSchema).default([
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateDeliveryRoute(context.search)),
      chart: await context.queryClient.fetchQuery(rangeDeliveryRoute({ from, to })),
    }
  },
})
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteDeliveryRoute, queryClient)
