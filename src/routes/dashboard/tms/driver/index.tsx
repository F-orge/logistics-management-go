...
import { deleteDriver, paginateDriver, rangeDriver } from '@/queries/tms/driver'
...
export const Route = createFileRoute('/dashboard/tms/driver/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(tmsDriverSchema).default([{ column: 'createdAt', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateDriver(context.search)),
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteDriver, queryClient)
