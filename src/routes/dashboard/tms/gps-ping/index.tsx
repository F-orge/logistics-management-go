...
import { deleteGpsPing, paginateGpsPing, rangeGpsPing } from '@/queries/tms/gps_ping'
...
export const Route = createFileRoute('/dashboard/tms/gps-ping/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(tmsGpsPingSchema).default([{ column: 'timestamp', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateGpsPing(context.search)),
