...
import { deleteCarrier, paginateCarrier, rangeCarrier } from '@/queries/tms/carrier'
...
export const Route = createFileRoute('/dashboard/tms/carrier/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(tmsCarrierSchema).default([{ column: 'createdAt', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateCarrier(context.search)),
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteCarrier, queryClient)
