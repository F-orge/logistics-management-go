...
import { deleteGeofence, paginateGeofence, rangeGeofence } from '@/queries/tms/geofence'
...
export const Route = createFileRoute('/dashboard/tms/geofence/')({
  ...
  validateSearch: zodValidator(
    paginateTransformer().extend({
      ...
      sort: sortTransformer(tmsGeofenceSchema).default([{ column: 'createdAt', order: 'desc' }]),
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginateGeofence(context.search)),
...
function RouteComponent() {
  ...
  const deleteMutation = useMutation(deleteGeofence, queryClient)
