...
export const Route = createFileRoute('/dashboard/tms/partner-invoice/')({
  ...
  async loader({ context }) {
    ...
    return {
      dataTable: await context.queryClient.fetchQuery(paginatePartnerInvoice(context.search)),
      chart: await context.queryClient.fetchQuery(rangePartnerInvoice({ from, to })),
    }
  },
})
