...
export const crmInvoiceSchema = z.object({
  ...
  issueDate: z.iso
    .datetime({ message: 'Invalid ISO datetime format for issue date' })
    .nullable(),
  dueDate: z.iso
    .datetime({ message: 'Invalid ISO datetime format for due date' })
    .nullable(),
  paidAt: z.iso
    .datetime({ message: 'Invalid ISO datetime format for paid at date' })
    .nullable(),
  sentAt: z.iso
    .datetime({ message: 'Invalid ISO datetime format for sent at date' })
    .nullable(),
  opportunityId: z
