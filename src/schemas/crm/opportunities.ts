...
export const crmOpportunitySchema = z.object({
  ...
  dealValue: z.coerce
    ...
    .nullable(),
  expectedCloseDate: z.iso.datetime({ message: 'Invalid ISO datetime format for expected close date' }).nullable(),
  lostReason: z
  ...
  probability: z
    ...
    .nullable(),
  source: z.enum(CrmOpportunitySource, { message: 'Invalid opportunity source' }).nullable(),
  stage: z.enum(CrmOpportunityStage, { message: 'Invalid opportunity stage' }).nullable(),
