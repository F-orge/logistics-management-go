...
export const tmsPartnerInvoiceItemInsertSchema = tmsPartnerInvoiceItemSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
})

export const tmsPartnerInvoiceItemUpdateSchema = tmsPartnerInvoiceItemInsertSchema.partial()
