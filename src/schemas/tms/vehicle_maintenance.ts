...
export const tmsVehicleMaintenanceInsertSchema = tmsVehicleMaintenanceSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
})

export const tmsVehicleMaintenanceUpdateSchema = tmsVehicleMaintenanceInsertSchema.partial()
