...
describe("BillingClientAccountSchema Validation", () => {
  describe("Valid Cases", () => {
    ...
    test.each(validTestCases)("should validate: $name", ({ input }) => {
      expect(() => billingClientAccountSchema.parse(input)).not.toThrow();
      const result = billingClientAccountSchema.parse(input);
  ...
  describe("Invalid Cases", () => {
    ...
    test.each(invalidTestCases)("should reject: $name", ({ input, expectedError }) => {
      ...
      try {
        billingClientAccountSchema.parse(input);
      } catch (e) {
  ...
  describe("SafeParse Tests for billingClientAccountSchema", () => {
    test("should return success for valid data", () => {
      const validData = {
        id: "123e4567-e89b-12d3-a456-426614174000",
        clientId: "123e4567-e89b-12d3-a456-426614174001",
      };
      const result = billingClientAccountSchema.safeParse(validData);
    ...
    test("should return error for invalid data", () => {
      ...
      const result = billingClientAccountSchema.safeParse(invalidData);
...
describe("BillingClientAccountInsertSchema Validation", () => {
  describe("Valid Cases", () => {
    ...
    test.each(validTestCases)("should validate: $name", ({ input }) => {
      expect(() => billingClientAccountInsertSchema.parse(input)).not.toThrow();
      const result = billingClientAccountInsertSchema.parse(input);
      expect(result).toEqual(expect.objectContaining(input));
    });
  });
  ...
  describe("Invalid Cases", () => {
    ...
    test.each(invalidTestCases)("should reject: $name", ({ input, expectedError }) => {
      let error: ZodError | undefined;
      try {
        billingClientAccountInsertSchema.parse(input);
      } catch (e) {
        if (e instanceof ZodError) {
          error = e;
        }
  ...
  describe("SafeParse Tests for billingClientAccountInsertSchema", () => {
    test("should return success for valid data", () => {
      const validData = {
        clientId: "123e4567-e89b-12d3-a456-426614174000",
      };
      const result = billingClientAccountInsertSchema.safeParse(validData);
    ...
    test("should return error for invalid data", () => {
      ...
      const result = billingClientAccountInsertSchema.safeParse(invalidData);
...
describe("BillingClientAccountUpdateSchema Validation", () => {
  describe("Valid Cases", () => {
    ...
    test.each(validTestCases)("should validate: $name", ({ input }) => {
      expect(() => billingClientAccountUpdateSchema.parse(input)).not.toThrow();
      const result = billingClientAccountUpdateSchema.parse(input);
      expect(result).toEqual(expect.objectContaining(input));
    });
  });
  ...
  describe("Invalid Cases", () => {
    ...
    test.each(invalidTestCases)("should reject: $name", ({ input, expectedError }) => {
      let error: ZodError | undefined;
      try {
        billingClientAccountUpdateSchema.parse(input);
      } catch (e) {
        if (e instanceof ZodError) {
          error = e;
        }
  ...
  describe("SafeParse Tests for billingClientAccountUpdateSchema", () => {
    test("should return success for valid data", () => {
      const validData = {
        availableCredit: 100.50,
      };
      const result = billingClientAccountUpdateSchema.safeParse(validData);
    ...
    test("should return error for invalid data", () => {
      ...
      const result = billingClientAccountUpdateSchema.safeParse(invalidData);
