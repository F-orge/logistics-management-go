...
export const billingDisputeSchema = z
  .object({
    id: z.uuid(),
    clientId: z.uuid(),
...
export const billingDisputeInsertSchema = billingDisputeSchema
  .omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
export const billingDisputeUpdateSchema = billingDisputeInsertSchema.partial().strict()
