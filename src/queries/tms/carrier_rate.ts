...
export const rangeCarrierRate = (options: Parameters<typeof orpcClient.tms.rangeCarrierRate>[0]) =>
  queryOptions({
...
export const inCarrierRate = (options: Parameters<typeof orpcClient.tms.inCarrierRate>[0]) =>
  queryOptions({
