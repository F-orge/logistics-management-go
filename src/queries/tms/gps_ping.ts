...
export const paginateGpsPing = (options: Parameters<typeof orpcClient.tms.paginateGpsPing>[0]) =>
  queryOptions({
...
export const rangeGpsPing = (options: Parameters<typeof orpcClient.tms.rangeGpsPing>[0]) =>
  queryOptions({
...
export const inGpsPing = (options: Parameters<typeof orpcClient.tms.inGpsPing>[0]) =>
  queryOptions({
