...
export const paginateTripStop = (
  options: Parameters<typeof orpcClient.tms.paginateTripStop>[0],
) =>
  queryOptions({
...
export const rangeTripStop = (
  options: Parameters<typeof orpcClient.tms.rangeTripStop>[0],
) =>
  queryOptions({
...
export const inTripStop = (
  options: Parameters<typeof orpcClient.tms.inTripStop>[0],
) =>
  queryOptions({
