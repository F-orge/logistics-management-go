...
export const rangeExpense = (
  options: Parameters<typeof orpcClient.tms.rangeExpense>[0],
) =>
  queryOptions({
...
export const inExpense = (
  options: Parameters<typeof orpcClient.tms.inExpense>[0],
) =>
  queryOptions({
