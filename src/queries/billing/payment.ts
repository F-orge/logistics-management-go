...
export const rangePayment = (options: Parameters<typeof orpcClient.billing.rangePayment>[0]) =>
  queryOptions({
...
export const inPayment = (options: Parameters<typeof orpcClient.billing.inPayment>[0]) =>
  queryOptions({
