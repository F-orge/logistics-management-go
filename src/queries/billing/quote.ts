...
export const paginateQuote = (options: Parameters<typeof orpcClient.billing.paginateQuote>[0]) =>
  queryOptions({
...
export const rangeQuote = (options: Parameters<typeof orpcClient.billing.rangeQuote>[0]) =>
  queryOptions({
...
export const inQuote = (options: Parameters<typeof orpcClient.billing.inQuote>[0]) =>
  queryOptions({
