...
export const rangeRateCard = (
  options: Parameters<typeof orpcClient.billing.rangeRateCard>[0],
) =>
  queryOptions({
...
export const inRateCard = (
  options: Parameters<typeof orpcClient.billing.inRateCard>[0],
) =>
  queryOptions({
