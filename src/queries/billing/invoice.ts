...
export const rangeInvoice = (options: Parameters<typeof orpcClient.billing.rangeInvoice>[0]) =>
  queryOptions({
...
export const inInvoice = (options: Parameters<typeof orpcClient.billing.inInvoice>[0]) =>
  queryOptions({
