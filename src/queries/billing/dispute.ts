...
export const rangeDispute = (options: Parameters<typeof orpcClient.billing.rangeDispute>[0]) =>
  queryOptions({
...
export const inDispute = (options: Parameters<typeof orpcClient.billing.inDispute>[0]) =>
  queryOptions({
