...
export const paginateSupplier = (options: Parameters<typeof orpcClient.wms.paginateSupplier>[0]) =>
  queryOptions({
...
export const rangeSupplier = (options: Parameters<typeof orpcClient.wms.rangeSupplier>[0]) =>
  queryOptions({
...
export const inSupplier = (options: Parameters<typeof orpcClient.wms.inSupplier>[0]) =>
  queryOptions({
