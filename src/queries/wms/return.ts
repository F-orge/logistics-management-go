...
export const paginateReturn = (options: Parameters<typeof orpcClient.wms.paginateReturn>[0]) =>
  queryOptions({
...
export const rangeReturn = (options: Parameters<typeof orpcClient.wms.rangeReturn>[0]) =>
  queryOptions({
...
export const inReturn = (options: Parameters<typeof orpcClient.wms.inReturn>[0]) =>
  queryOptions({
