...
export const rangePackageItem = (options: Parameters<typeof orpcClient.wms.rangePackageItem>[0]) =>
  queryOptions({
...
export const inPackageItem = (options: Parameters<typeof orpcClient.wms.inPackageItem>[0]) =>
  queryOptions({
