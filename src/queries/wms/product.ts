...
export const paginateProduct = (
  options: Parameters<typeof orpcClient.wms.paginateProduct>[0],
) =>
  queryOptions({
...
export const rangeProduct = (
  options: Parameters<typeof orpcClient.wms.rangeProduct>[0],
) =>
  queryOptions({
...
export const inProduct = (
  options: Parameters<typeof orpcClient.wms.inProduct>[0],
) =>
  queryOptions({
