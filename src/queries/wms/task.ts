...
export const paginateTask = (options: Parameters<typeof orpcClient.wms.paginateTask>[0]) =>
  queryOptions({
...
export const rangeTask = (options: Parameters<typeof orpcClient.wms.rangeTask>[0]) =>
  queryOptions({
