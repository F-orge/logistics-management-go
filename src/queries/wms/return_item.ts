...
export const rangeReturnItem = (options: Parameters<typeof orpcClient.wms.rangeReturnItem>[0]) =>
  queryOptions({
...
export const inReturnItem = (options: Parameters<typeof orpcClient.wms.inReturnItem>[0]) =>
  queryOptions({
