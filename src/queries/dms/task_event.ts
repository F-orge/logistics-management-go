...
export const rangeTaskEvent = (options: Parameters<typeof orpcClient.dms.rangeTaskEvent>[0]) =>
  queryOptions({
...
export const inTaskEvent = (options: Parameters<typeof orpcClient.dms.inTaskEvent>[0]) =>
  queryOptions({
