// Create/Update structs for lms_provider_service_max_dimensions
...
pub struct CreateProviderServiceMaxDimension {
...
impl IntoActiveModel<ActiveModel> for CreateProviderServiceMaxDimension {
