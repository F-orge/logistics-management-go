// Create/Update structs for lms_provider_service_destination_countries
...
pub struct CreateProviderServiceDestinationCountry {
    pub provider_service_id: Uuid,
    pub country_code: String,
}

impl IntoActiveModel<ActiveModel> for CreateProviderServiceDestinationCountry {
