...
#[graphql(name = "LmsProviderRatesModel")]
pub struct Model {
...
#[graphql(name = "LmsProviderRatesColumn")]
pub enum Column {
    Id,
    ProviderServiceId,
    OriginZoneId,
...
impl RelationTrait for Relation {
    fn def(&self) -> RelationDef {
        match self {
            Self::LmsPricingZones2 => Entity::belongs_to(super::lms_pricing_zones::Entity)
                .from(Column::DestinationZoneId)
                .to(super::lms_pricing_zones::Column::Id)
                .into(),
            Self::LmsPricingZones1 => Entity::belongs_to(super::lms_pricing_zones::Entity)
