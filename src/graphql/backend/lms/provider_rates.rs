...
pub struct ProviderRatesSort {
    pub column: ProviderRateColumn,
    pub order: SortOrder,
}

#[derive(Debug, Clone, InputObject)]
pub struct ProviderRateFilter {
    pub column: ProviderRateColumn,
...
impl ProviderRatesQuery {
    ...
    async fn list(
        ...
        page: u64,
        limit: u64,
        sort_by: Option<Vec<ProviderRatesSort>>,
        filter_by: Option<Vec<ProviderRateFilter>>,
