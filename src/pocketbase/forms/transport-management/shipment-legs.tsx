...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.TransportManagementShipmentLegs>,
		validators: {
...
export const ShipmentLegsForm = withForm({
	defaultValues: {} as
		| Create<Collections.TransportManagementShipmentLegs>
		| Update<Collections.TransportManagementShipmentLegs>,
	render: ({ form }) => {
