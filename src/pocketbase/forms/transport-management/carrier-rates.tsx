...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.TransportManagementCarrierRates>,
    validators: {
...
export const CarrierRatesForm = withForm({
  defaultValues: {} as Create<Collections.TransportManagementCarrierRates> | Update<Collections.TransportManagementCarrierRates>,
  render: ({ form }) => {
