...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.TransportManagementProofOfDeliveries>,
		validators: {
...
export const ProofOfDeliveriesForm = withForm({
	defaultValues: {} as
		| Create<Collections.TransportManagementProofOfDeliveries>
		| Update<Collections.TransportManagementProofOfDeliveries>,
	render: ({ form }) => {
