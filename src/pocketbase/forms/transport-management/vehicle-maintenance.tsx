...
export const CreateFormOptionFactory = (pocketbase: TypedPocketBase) =>
  formOptions({
    defaultValues: {} as Create<Collections.TransportManagementVehicleMaintenance>,
    validators: {
...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.TransportManagementVehicleMaintenance>,
    validators: {
...
export const VehicleMaintenanceForm = withForm({
  defaultValues: {} as Create<Collections.TransportManagementVehicleMaintenance> | Update<Collections.TransportManagementVehicleMaintenance>,
  render: ({ form }) => {
