...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.TransportManagementGeofenceEvents>,
    validators: {
...
export const GeofenceEventsForm = withForm({
  defaultValues: {} as Create<Collections.TransportManagementGeofenceEvents> | Update<Collections.TransportManagementGeofenceEvents>,
  render: ({ form }) => {
