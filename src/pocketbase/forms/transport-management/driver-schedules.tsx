...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.TransportManagementDriverSchedules>,
    validators: {
...
export const DriverSchedulesForm = withForm({
  defaultValues: {} as Create<Collections.TransportManagementDriverSchedules> | Update<Collections.TransportManagementDriverSchedules>,
  render: ({ form }) => {
