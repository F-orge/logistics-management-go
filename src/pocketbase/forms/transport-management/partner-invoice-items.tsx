...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.TransportManagementPartnerInvoiceItems>,
		validators: {
...
export const PartnerInvoiceItemsForm = withForm({
	defaultValues: {} as
		| Create<Collections.TransportManagementPartnerInvoiceItems>
		| Update<Collections.TransportManagementPartnerInvoiceItems>,
	render: ({ form }) => {
			...
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage invoice information</FieldDescription>
