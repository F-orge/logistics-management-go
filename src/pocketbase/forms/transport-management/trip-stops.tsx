...
export const TripStopsForm = withForm({
	defaultValues: {} as
		| Create<Collections.TransportManagementTripStops>
		| Update<Collections.TransportManagementTripStops>,
	render: ({ form }) => {
			...
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage coordinates information</FieldDescription>
