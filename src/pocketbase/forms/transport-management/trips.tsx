...
export const TripsForm = withForm({
	defaultValues: {} as
		| Create<Collections.TransportManagementTrips>
		| Update<Collections.TransportManagementTrips>,
	render: ({ form }) => {
						...
						<form.AppField name="driver">
							{(field) => (
								<field.RelationField<TransportManagementDriversResponse>
									...
									collectionName={
										Collections.Collections.TransportManagementDrivers
									}
						...
						<form.AppField name="vehicle">
							{(field) => (
								<field.RelationField<TransportManagementVehiclesResponse>
									pocketbase={pocketbase}
									collectionName={
										Collections.Collections.TransportManagementVehicles
									}
