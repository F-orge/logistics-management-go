...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.TransportManagementPartnerInvoice>,
    validators: {
...
export const PartnerInvoiceForm = withForm({
  defaultValues: {} as Create<Collections.TransportManagementPartnerInvoice> | Update<Collections.TransportManagementPartnerInvoice>,
  render: ({ form }) => {
