...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.TransportManagementShipmentLegEvents>,
		validators: {
...
export const ShipmentLegEventsForm = withForm({
	defaultValues: {} as
		| Create<Collections.TransportManagementShipmentLegEvents>
		| Update<Collections.TransportManagementShipmentLegEvents>,
	render: ({ form }) => {
