...
export const TasksForm = withForm({
  defaultValues: {} as Create<Collections.DeliveryManagementTasks> | Update<Collections.DeliveryManagementTasks>,
  render: ({ form }) => {
      ...
      <form.AppForm>
        <FieldSet>
          ...
          <FieldGroup>
            ...
            <FieldDescription>
              Manage instructions information
            </FieldDescription>
            ...
            <form.AppField name="failureReason">
              {(field) => (
                <field.SelectField
                  ...
                  options={[
                    { label: "Reecipient-not-home", value: "reecipient-not-home" },
