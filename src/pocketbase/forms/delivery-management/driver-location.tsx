...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.DeliveryManagementDriverLocation>,
		validators: {
...
export const DriverLocationForm = withForm({
	defaultValues: {} as
		| Create<Collections.DeliveryManagementDriverLocation>
		| Update<Collections.DeliveryManagementDriverLocation>,
	render: ({ form }) => {
