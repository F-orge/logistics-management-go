...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.DeliveryManagementProofOfDeliveries>,
		validators: {
...
export const ProofOfDeliveriesForm = withForm({
	defaultValues: {} as
		| Create<Collections.DeliveryManagementProofOfDeliveries>
		| Update<Collections.DeliveryManagementProofOfDeliveries>,
	render: ({ form }) => {
