...
export const RateRulesForm = withForm({
	defaultValues: {} as
		| Create<Collections.BillingManagementRateRules>
		| Update<Collections.BillingManagementRateRules>,
	render: ({ form }) => {
			...
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage rate card information</FieldDescription>
