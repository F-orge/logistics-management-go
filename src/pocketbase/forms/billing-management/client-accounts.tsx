...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.BillingManagementClientAccounts>,
		validators: {
...
export const ClientAccountsForm = withForm({
	defaultValues: {} as
		| Create<Collections.BillingManagementClientAccounts>
		| Update<Collections.BillingManagementClientAccounts>,
	render: ({ form }) => {
			...
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage client info information</FieldDescription>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage credit information</FieldDescription>
