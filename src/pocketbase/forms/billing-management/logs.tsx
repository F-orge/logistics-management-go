...
export const LogsForm = withForm({
	defaultValues: {} as
		| Create<Collections.BillingManagementLogs>
		| Update<Collections.BillingManagementLogs>,
	render: ({ form }) => {
		return (
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage system information</FieldDescription>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage record information</FieldDescription>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage external information</FieldDescription>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage retry information</FieldDescription>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage error information</FieldDescription>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage payloads information</FieldDescription>
