...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.BillingManagementInvoiceLineItems>,
		validators: {
...
export const InvoiceLineItemsForm = withForm({
	defaultValues: {} as
		| Create<Collections.BillingManagementInvoiceLineItems>
		| Update<Collections.BillingManagementInvoiceLineItems>,
	render: ({ form }) => {
			...
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage item information</FieldDescription>
