...
export const LeadsForm = withForm({
  defaultValues: {} as Create<Collections.CustomerRelationsLeads> | Update<Collections.CustomerRelationsLeads>,
  render: ({ form }) => {
      ...
      <form.AppForm>
        <FieldSet>
          ...
          <FieldGroup>
            ...
            <FieldDescription>
              Manage lead source information
            </FieldDescription>
          ...
          <FieldGroup>
            ...
            <FieldDescription>
              Manage lead status information
            </FieldDescription>
            ...
            <form.AppField name="campaign">
              {(field) => (
                <field.RelationField<CustomerRelationsCampaignsResponse>
                  ...
                  collectionName={Collections.Collections.CustomerRelationsCampaigns}
