...
export const CompaniesForm = withForm({
	defaultValues: {} as
		| Create<Collections.CustomerRelationsCompanies>
		| Update<Collections.CustomerRelationsCompanies>,
	render: ({ form }) => {
		return (
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage business information</FieldDescription>
