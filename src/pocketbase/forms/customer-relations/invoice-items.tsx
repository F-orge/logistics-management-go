...
import { CustomerRelationsInvoiceItemsSchema } from "@/pocketbase/pb-schemas";

export const MutationSchema = CustomerRelationsInvoiceItemsSchema.omit({
  id: true,
  created: true,
  updated: true,
    ...
    onSubmit: async ({ value }) => {
      ...
      await toast
        .promise(resultPromise, {
          success: `InvoiceItems created successfully`,
        })
        .unwrap();
    },
  });
...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.CustomerRelationsInvoiceItems>,
    validators: {
    ...
    onSubmit: async ({ value }) => {
      ...
      await toast
        .promise(resultPromise, {
          success: "InvoiceItems updated successfully",
        })
        .unwrap();
    },
  });

export const InvoiceItemsForm = withForm({
  defaultValues: {} as Create<Collections.CustomerRelationsInvoiceItems> | Update<Collections.CustomerRelationsInvoiceItems>,
  render: ({ form }) => {
        ...
        <FieldSet>
          ...
          <FieldGroup>
            ...
            <form.AppField name="invoice">
              {(field) => (
                <field.RelationField<CustomerRelationsInvoicesResponse>
          ...
          <FieldGroup>
            ...
            <FieldDescription>
              Manage item details information
            </FieldDescription>
...
const CreateForm = () => {
  ...
  return (
    <form.AppForm>
      ...
      >
        <InvoiceItemsForm form={form as any} />
      </FormDialog>
    </form.AppForm>
  );
};
...
const UpdateForm = () => {
  ...
  const { data: record } = useSuspenseQuery({
    queryKey: ["invoiceitems", searchQuery.id],
    queryFn: () =>
      pocketbase
        .collection(Collections.CustomerRelationsInvoiceItems)
        .getOne<CustomerRelationsInvoiceItemsRecord>(searchQuery.id!),
  });
