...
export const CreateFormOptionFactory = (pocketbase: TypedPocketBase) =>
  formOptions({
    defaultValues: {} as Create<Collections.CustomerRelationsOpportunityProducts>,
    validators: {
...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.CustomerRelationsOpportunityProducts>,
    validators: {
...
export const OpportunityProductsForm = withForm({
  defaultValues: {} as Create<Collections.CustomerRelationsOpportunityProducts> | Update<Collections.CustomerRelationsOpportunityProducts>,
  render: ({ form }) => {
