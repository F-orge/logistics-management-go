...
export const OpportunitiesForm = withForm({
  defaultValues: {} as Create<Collections.CustomerRelationsOpportunities> | Update<Collections.CustomerRelationsOpportunities>,
  render: ({ form }) => {
            ...
            <form.AppField name="company">
              {(field) => (
                <field.RelationField<CustomerRelationsCompaniesResponse>
                  ...
                  collectionName={Collections.Collections.CustomerRelationsCompanies}
            ...
            <form.AppField name="contact">
              {(field) => (
                <field.RelationField<CustomerRelationsContactsResponse>
                  pocketbase={pocketbase}
                  collectionName={Collections.Collections.CustomerRelationsContacts}
