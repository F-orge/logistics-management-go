...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.WarehouseManagementPutawayRules>,
		validators: {
...
export const PutawayRulesForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementPutawayRules>
		| Update<Collections.WarehouseManagementPutawayRules>,
	render: ({ form }) => {
