...
export const CreateFormOptionFactory = (pocketbase: TypedPocketBase) =>
  formOptions({
    defaultValues: {} as Create<Collections.WarehouseManagementInboundShipments>,
    validators: {
...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.WarehouseManagementInboundShipments>,
    validators: {
...
export const InboundShipmentsForm = withForm({
  defaultValues: {} as Create<Collections.WarehouseManagementInboundShipments> | Update<Collections.WarehouseManagementInboundShipments>,
  render: ({ form }) => {
