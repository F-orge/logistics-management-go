...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.WarehouseManagementOutboundShipments>,
		validators: {
...
export const OutboundShipmentsForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementOutboundShipments>
		| Update<Collections.WarehouseManagementOutboundShipments>,
	render: ({ form }) => {
