...
export const PickBatchesForm = withForm({
  defaultValues: {} as Create<Collections.WarehouseManagementPickBatches> | Update<Collections.WarehouseManagementPickBatches>,
  render: ({ form }) => {
