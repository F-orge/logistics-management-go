...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.WarehouseManagementPackageItems>,
		validators: {
...
export const PackageItemsForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementPackageItems>
		| Update<Collections.WarehouseManagementPackageItems>,
	render: ({ form }) => {
