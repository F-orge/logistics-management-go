...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.WarehouseManagementPickBatchItems>,
    validators: {
...
export const PickBatchItemsForm = withForm({
  defaultValues: {} as Create<Collections.WarehouseManagementPickBatchItems> | Update<Collections.WarehouseManagementPickBatchItems>,
  render: ({ form }) => {
