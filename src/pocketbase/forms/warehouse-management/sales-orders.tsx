...
export const SalesOrdersForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementSalesOrders>
		| Update<Collections.WarehouseManagementSalesOrders>,
	render: ({ form }) => {
			...
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage customer information</FieldDescription>
