...
export const WarehousesForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementWarehouses>
		| Update<Collections.WarehouseManagementWarehouses>,
	render: ({ form }) => {
		return (
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage geolocation information</FieldDescription>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage media information</FieldDescription>
