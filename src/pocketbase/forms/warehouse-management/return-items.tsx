...
export const ReturnItemsForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementReturnItems>
		| Update<Collections.WarehouseManagementReturnItems>,
	render: ({ form }) => {
			...
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage return information</FieldDescription>
