...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.WarehouseManagementStockTransfer>,
		validators: {
...
export const StockTransferForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementStockTransfer>
		| Update<Collections.WarehouseManagementStockTransfer>,
	render: ({ form }) => {
