...
export const MutationSchema =
	WarehouseManagementOutboundShipmentItemsSchema.omit({
		id: true,
		created: true,
		updated: true,
...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.WarehouseManagementOutboundShipmentItems>,
		validators: {
...
export const OutboundShipmentItemsForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementOutboundShipmentItems>
		| Update<Collections.WarehouseManagementOutboundShipmentItems>,
	render: ({ form }) => {
...
const UpdateForm = () => {
	...
	const { data: record } = useSuspenseQuery({
		...
		queryFn: () =>
			pocketbase
				.collection(Collections.WarehouseManagementOutboundShipmentItems)
				.getOne<WarehouseManagementOutboundShipmentItemsRecord>(
					searchQuery.id!,
				),
	});
