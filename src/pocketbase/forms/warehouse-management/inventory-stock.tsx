...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.WarehouseManagementInventoryStock>,
    validators: {
...
export const InventoryStockForm = withForm({
  defaultValues: {} as Create<Collections.WarehouseManagementInventoryStock> | Update<Collections.WarehouseManagementInventoryStock>,
  render: ({ form }) => {
