...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.WarehouseManagementInventoryAdjustment>,
		validators: {
...
export const InventoryAdjustmentForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementInventoryAdjustment>
		| Update<Collections.WarehouseManagementInventoryAdjustment>,
	render: ({ form }) => {
