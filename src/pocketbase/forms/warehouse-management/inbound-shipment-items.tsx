...
export const MutationSchema = WarehouseManagementInboundShipmentItemsSchema.omit({
  id: true,
  created: true,
  updated: true,
...
export const CreateFormOptionFactory = (pocketbase: TypedPocketBase) =>
  formOptions({
    defaultValues: {} as Create<Collections.WarehouseManagementInboundShipmentItems>,
    validators: {
...
export const UpdateFormOptionFactory = (
  ...
  formOptions({
    defaultValues: record as Update<Collections.WarehouseManagementInboundShipmentItems>,
    validators: {
...
export const InboundShipmentItemsForm = withForm({
  defaultValues: {} as Create<Collections.WarehouseManagementInboundShipmentItems> | Update<Collections.WarehouseManagementInboundShipmentItems>,
  render: ({ form }) => {
