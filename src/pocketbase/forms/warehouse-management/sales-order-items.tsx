...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.WarehouseManagementSalesOrderItems>,
		validators: {
...
export const SalesOrderItemsForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementSalesOrderItems>
		| Update<Collections.WarehouseManagementSalesOrderItems>,
	render: ({ form }) => {
