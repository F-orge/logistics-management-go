...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.WarehouseManagementBinThreshold>,
		validators: {
...
export const BinThresholdForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementBinThreshold>
		| Update<Collections.WarehouseManagementBinThreshold>,
	render: ({ form }) => {
