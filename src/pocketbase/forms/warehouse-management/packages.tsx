...
export const PackagesForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementPackages>
		| Update<Collections.WarehouseManagementPackages>,
	render: ({ form }) => {
			...
			<form.AppForm>
				<FieldSet>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage flags information</FieldDescription>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage packing information</FieldDescription>
					...
					<FieldGroup>
						...
						<FieldDescription>Manage shipping information</FieldDescription>
