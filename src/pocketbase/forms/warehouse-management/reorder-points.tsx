...
export const UpdateFormOptionFactory = (
	...
	formOptions({
		defaultValues:
			record as Update<Collections.WarehouseManagementReorderPoints>,
		validators: {
...
export const ReorderPointsForm = withForm({
	defaultValues: {} as
		| Create<Collections.WarehouseManagementReorderPoints>
		| Update<Collections.WarehouseManagementReorderPoints>,
	render: ({ form }) => {
