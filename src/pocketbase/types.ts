...
export type LmsTransportProviderInvoiceLineItemsResponse<Texpand = unknown> =
  Required<LmsTransportProviderInvoiceLineItemsRecord> &
    BaseSystemFields<Texpand>;
export type LmsTransportProviderInvoicesResponse<Texpand = unknown> =
  Required<LmsTransportProviderInvoicesRecord> & BaseSystemFields<Texpand>;
export type LmsTransportProviderPerformanceResponse<Texpand = unknown> =
  Required<LmsTransportProviderPerformanceRecord> & BaseSystemFields<Texpand>;
export type LmsTransportProviderRatesResponse<Texpand = unknown> =
  Required<LmsTransportProviderRatesRecord> & BaseSystemFields<Texpand>;
export type LmsTransportProviderServiceDestinationCountriesResponse<
  Texpand = unknown,
> = Required<LmsTransportProviderServiceDestinationCountriesRecord> &
  BaseSystemFields<Texpand>;
export type LmsTransportProviderServiceMaxDimensionsResponse<
  Texpand = unknown,
> = Required<LmsTransportProviderServiceMaxDimensionsRecord> &
  BaseSystemFields<Texpand>;
export type LmsTransportProviderServiceOriginCountriesResponse<
  Texpand = unknown,
> = Required<LmsTransportProviderServiceOriginCountriesRecord> &
  BaseSystemFields<Texpand>;
export type LmsTransportProviderServicesResponse<Texpand = unknown> =
  Required<LmsTransportProviderServicesRecord> & BaseSystemFields<Texpand>;
...
export type TypedPocketBase = PocketBase & {
  ...
  collection(
    idOrName: 'lms_transport_provider_invoice_line_items',
  ): RecordService<LmsTransportProviderInvoiceLineItemsResponse>;
  collection(
    idOrName: 'lms_transport_provider_invoices',
  ): RecordService<LmsTransportProviderInvoicesResponse>;
  collection(
    idOrName: 'lms_transport_provider_performance',
  ): RecordService<LmsTransportProviderPerformanceResponse>;
  collection(
    idOrName: 'lms_transport_provider_rates',
  ): RecordService<LmsTransportProviderRatesResponse>;
  collection(
    idOrName: 'lms_transport_provider_service_destination_countries',
  ): RecordService<LmsTransportProviderServiceDestinationCountriesResponse>;
  collection(
    idOrName: 'lms_transport_provider_service_max_dimensions',
  ): RecordService<LmsTransportProviderServiceMaxDimensionsResponse>;
  collection(
    idOrName: 'lms_transport_provider_service_origin_countries',
  ): RecordService<LmsTransportProviderServiceOriginCountriesResponse>;
  collection(
    idOrName: 'lms_transport_provider_services',
  ): RecordService<LmsTransportProviderServicesResponse>;
  collection(
