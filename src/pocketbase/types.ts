...
export enum Collections {
	...
	LmsTransportProviderInvoiceLineItems = "lms_transport_provider_invoice_line_items",
	LmsTransportProviderInvoices = "lms_transport_provider_invoices",
	LmsTransportProviderPerformance = "lms_transport_provider_performance",
	LmsTransportProviderRates = "lms_transport_provider_rates",
	LmsTransportProviderServiceDestinationCountries = "lms_transport_provider_service_destination_countries",
	LmsTransportProviderServiceMaxDimensions = "lms_transport_provider_service_max_dimensions",
	LmsTransportProviderServiceOriginCountries = "lms_transport_provider_service_origin_countries",
	LmsTransportProviderServices = "lms_transport_provider_services",
...
export type LmsTransportProviderInvoiceLineItemsRecord = {
	created?: IsoDateString
	description: HTMLString
	id: string
	line_total?: number
...
export enum LmsTransportProviderInvoicesStatusOptions {
	"draft" = "draft",
	"sent" = "sent",
	"paid" = "paid",
	"overdue" = "overdue",
...
export type LmsTransportProviderInvoicesRecord = {
	created?: IsoDateString
	currency: string
	due_date: IsoDateString
	id: string
	...
	status?: LmsTransportProviderInvoicesStatusOptions
	subtotal: number
	tax_amount: number
	total_amount?: number
	updated?: IsoDateString
...
export enum LmsTransportProviderPerformanceMetricTypeOptions {
	"on_time_delivery" = "on_time_delivery",
	"damage_rate" = "damage_rate",
	"cost_efficiency" = "cost_efficiency",
	"customer_satisfaction" = "customer_satisfaction",
}
export type LmsTransportProviderPerformanceRecord = {
	created?: IsoDateString
	id: string
	measurement_date: IsoDateString
	metric_type: LmsTransportProviderPerformanceMetricTypeOptions
	metric_value: number
	notes?: HTMLString
	provider: RecordIdString
	shipment: RecordIdString
...
export type LmsTransportProviderRatesRecord = {
	base_rate?: number
	created?: IsoDateString
	currency: string
...
export type LmsTransportProviderServiceDestinationCountriesRecord = {
	country_code: string
	created?: IsoDateString
	id: string
	provider: RecordIdString
...
export type LmsTransportProviderServiceMaxDimensionsRecord = {
	created?: IsoDateString
	height?: number
	id: string
	length?: number
...
export type LmsTransportProviderServiceOriginCountriesRecord = {
	country_code: string
	created?: IsoDateString
	id: string
	provider: RecordIdString
...
export enum LmsTransportProviderServicesTypeOptions {
	"standard" = "standard",
	"express" = "express",
	"overnight" = "overnight",
	"economy" = "economy",
...
export enum LmsTransportProviderServicesTransportModeOptions {
	"air" = "air",
	"sea" = "sea",
	"road" = "road",
	"rail" = "rail",
}
export type LmsTransportProviderServicesRecord = {
	created?: IsoDateString
	...
	transport_mode: LmsTransportProviderServicesTransportModeOptions
	type: LmsTransportProviderServicesTypeOptions
	updated?: IsoDateString
}
...
export type CrmInvoiceLineItemsResponse<Texpand = unknown> = Required<CrmInvoiceLineItemsRecord> & BaseSystemFields<Texpand>
export type CrmInvoicesResponse<Texpand = unknown> = Required<CrmInvoicesRecord> & BaseSystemFields<Texpand>
...
export type LmsAddressesResponse<Texpand = unknown> = Required<LmsAddressesRecord> & BaseSystemFields<Texpand>
export type LmsPackagesResponse<Texpand = unknown> = Required<LmsPackagesRecord> & BaseSystemFields<Texpand>
export type LmsPricingRatesResponse<Texpand = unknown> = Required<LmsPricingRatesRecord> & BaseSystemFields<Texpand>
export type LmsPricingZoneCountriesResponse<Texpand = unknown> = Required<LmsPricingZoneCountriesRecord> & BaseSystemFields<Texpand>
export type LmsPricingZonesResponse<Texpand = unknown> = Required<LmsPricingZonesRecord> & BaseSystemFields<Texpand>
export type LmsShipmentsResponse<Texpand = unknown> = Required<LmsShipmentsRecord> & BaseSystemFields<Texpand>
export type LmsShippingServiceMaxDimensionsResponse<Texpand = unknown> = Required<LmsShippingServiceMaxDimensionsRecord> & BaseSystemFields<Texpand>
export type LmsShippingServicesResponse<Texpand = unknown> = Required<LmsShippingServicesRecord> & BaseSystemFields<Texpand>
export type LmsTrackingEventsResponse<Texpand = unknown> = Required<LmsTrackingEventsRecord> & BaseSystemFields<Texpand>
export type LmsTransportProviderInvoiceLineItemsResponse<Texpand = unknown> = Required<LmsTransportProviderInvoiceLineItemsRecord> & BaseSystemFields<Texpand>
export type LmsTransportProviderInvoicesResponse<Texpand = unknown> = Required<LmsTransportProviderInvoicesRecord> & BaseSystemFields<Texpand>
export type LmsTransportProviderPerformanceResponse<Texpand = unknown> = Required<LmsTransportProviderPerformanceRecord> & BaseSystemFields<Texpand>
export type LmsTransportProviderRatesResponse<Texpand = unknown> = Required<LmsTransportProviderRatesRecord> & BaseSystemFields<Texpand>
export type LmsTransportProviderServiceDestinationCountriesResponse<Texpand = unknown> = Required<LmsTransportProviderServiceDestinationCountriesRecord> & BaseSystemFields<Texpand>
export type LmsTransportProviderServiceMaxDimensionsResponse<Texpand = unknown> = Required<LmsTransportProviderServiceMaxDimensionsRecord> & BaseSystemFields<Texpand>
export type LmsTransportProviderServiceOriginCountriesResponse<Texpand = unknown> = Required<LmsTransportProviderServiceOriginCountriesRecord> & BaseSystemFields<Texpand>
export type LmsTransportProviderServicesResponse<Texpand = unknown> = Required<LmsTransportProviderServicesRecord> & BaseSystemFields<Texpand>
export type LmsTransportProvidersResponse<Texpand = unknown> = Required<LmsTransportProvidersRecord> & BaseSystemFields<Texpand>
export type LmsWarehouseInventoriesResponse<Texpand = unknown> = Required<LmsWarehouseInventoriesRecord> & BaseSystemFields<Texpand>
export type LmsWarehousesResponse<Texpand = unknown> = Required<LmsWarehousesRecord> & BaseSystemFields<Texpand>
...
export type TmsDriversResponse<Texpand = unknown> = Required<TmsDriversRecord> & BaseSystemFields<Texpand>
export type TmsVehiclesResponse<Texpand = unknown> = Required<TmsVehiclesRecord> & BaseSystemFields<Texpand>
...
export type CollectionRecords = {
	...
	lms_transport_provider_invoice_line_items: LmsTransportProviderInvoiceLineItemsRecord
	lms_transport_provider_invoices: LmsTransportProviderInvoicesRecord
	lms_transport_provider_performance: LmsTransportProviderPerformanceRecord
	lms_transport_provider_rates: LmsTransportProviderRatesRecord
	lms_transport_provider_service_destination_countries: LmsTransportProviderServiceDestinationCountriesRecord
	lms_transport_provider_service_max_dimensions: LmsTransportProviderServiceMaxDimensionsRecord
	lms_transport_provider_service_origin_countries: LmsTransportProviderServiceOriginCountriesRecord
	lms_transport_provider_services: LmsTransportProviderServicesRecord
...
export type CollectionResponses = {
	...
	lms_transport_provider_invoice_line_items: LmsTransportProviderInvoiceLineItemsResponse
	lms_transport_provider_invoices: LmsTransportProviderInvoicesResponse
	lms_transport_provider_performance: LmsTransportProviderPerformanceResponse
	lms_transport_provider_rates: LmsTransportProviderRatesResponse
	lms_transport_provider_service_destination_countries: LmsTransportProviderServiceDestinationCountriesResponse
	lms_transport_provider_service_max_dimensions: LmsTransportProviderServiceMaxDimensionsResponse
	lms_transport_provider_service_origin_countries: LmsTransportProviderServiceOriginCountriesResponse
	lms_transport_provider_services: LmsTransportProviderServicesResponse
...
export type TypedPocketBase = PocketBase & {
	...
	collection(idOrName: 'crm_invoice_line_items'): RecordService<CrmInvoiceLineItemsResponse>
	...
	collection(idOrName: 'lms_pricing_rates'): RecordService<LmsPricingRatesResponse>
	collection(idOrName: 'lms_pricing_zone_countries'): RecordService<LmsPricingZoneCountriesResponse>
	collection(idOrName: 'lms_pricing_zones'): RecordService<LmsPricingZonesResponse>
	collection(idOrName: 'lms_shipments'): RecordService<LmsShipmentsResponse>
	collection(idOrName: 'lms_shipping_service_max_dimensions'): RecordService<LmsShippingServiceMaxDimensionsResponse>
	collection(idOrName: 'lms_shipping_services'): RecordService<LmsShippingServicesResponse>
	collection(idOrName: 'lms_tracking_events'): RecordService<LmsTrackingEventsResponse>
	collection(idOrName: 'lms_transport_provider_invoice_line_items'): RecordService<LmsTransportProviderInvoiceLineItemsResponse>
	collection(idOrName: 'lms_transport_provider_invoices'): RecordService<LmsTransportProviderInvoicesResponse>
	collection(idOrName: 'lms_transport_provider_performance'): RecordService<LmsTransportProviderPerformanceResponse>
	collection(idOrName: 'lms_transport_provider_rates'): RecordService<LmsTransportProviderRatesResponse>
	collection(idOrName: 'lms_transport_provider_service_destination_countries'): RecordService<LmsTransportProviderServiceDestinationCountriesResponse>
	collection(idOrName: 'lms_transport_provider_service_max_dimensions'): RecordService<LmsTransportProviderServiceMaxDimensionsResponse>
	collection(idOrName: 'lms_transport_provider_service_origin_countries'): RecordService<LmsTransportProviderServiceOriginCountriesResponse>
	collection(idOrName: 'lms_transport_provider_services'): RecordService<LmsTransportProviderServicesResponse>
	collection(idOrName: 'lms_transport_providers'): RecordService<LmsTransportProvidersResponse>
	collection(idOrName: 'lms_warehouse_inventories'): RecordService<LmsWarehouseInventoriesResponse>
