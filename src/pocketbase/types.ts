...
export type LmsProviderInvoiceLineItemsResponse<Texpand = unknown> = Required<LmsProviderInvoiceLineItemsRecord> & BaseSystemFields<Texpand>
export type LmsProviderInvoicesResponse<Texpand = unknown> = Required<LmsProviderInvoicesRecord> & BaseSystemFields<Texpand>
export type LmsProviderPerformanceResponse<Texpand = unknown> = Required<LmsProviderPerformanceRecord> & BaseSystemFields<Texpand>
export type LmsProviderRatesResponse<Texpand = unknown> = Required<LmsProviderRatesRecord> & BaseSystemFields<Texpand>
export type LmsProviderServiceDestinationCountriesResponse<Texpand = unknown> = Required<LmsProviderServiceDestinationCountriesRecord> & BaseSystemFields<Texpand>
export type LmsProviderServiceMaxDimensionsResponse<Texpand = unknown> = Required<LmsProviderServiceMaxDimensionsRecord> & BaseSystemFields<Texpand>
export type LmsProviderServiceOriginCountriesResponse<Texpand = unknown> = Required<LmsProviderServiceOriginCountriesRecord> & BaseSystemFields<Texpand>
export type LmsProviderServicesResponse<Texpand = unknown> = Required<LmsProviderServicesRecord> & BaseSystemFields<Texpand>
...
export type TypedPocketBase = PocketBase & {
	...
	collection(idOrName: 'lms_provider_invoice_line_items'): RecordService<LmsProviderInvoiceLineItemsResponse>
	collection(idOrName: 'lms_provider_invoices'): RecordService<LmsProviderInvoicesResponse>
	collection(idOrName: 'lms_provider_performance'): RecordService<LmsProviderPerformanceResponse>
	collection(idOrName: 'lms_provider_rates'): RecordService<LmsProviderRatesResponse>
	collection(idOrName: 'lms_provider_service_destination_countries'): RecordService<LmsProviderServiceDestinationCountriesResponse>
	collection(idOrName: 'lms_provider_service_max_dimensions'): RecordService<LmsProviderServiceMaxDimensionsResponse>
	collection(idOrName: 'lms_provider_service_origin_countries'): RecordService<LmsProviderServiceOriginCountriesResponse>
	collection(idOrName: 'lms_provider_services'): RecordService<LmsProviderServicesResponse>
