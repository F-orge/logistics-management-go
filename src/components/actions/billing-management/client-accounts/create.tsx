...
export const CreateSchema = z.object({
	...
	availableCredit: ClientAccountsSchema.shape.availableCredit.register(
		fieldRegistry,
		{
	...
	walletBalance: ClientAccountsSchema.shape.walletBalance.register(
		fieldRegistry,
		{
	...
	paymentTermsDays: ClientAccountsSchema.shape.paymentTermsDays.register(
		fieldRegistry,
		{
	...
	isCreditApproved: ClientAccountsSchema.shape.isCreditApproved.register(
		fieldRegistry,
		{
	...
	lastPaymentDate: ClientAccountsSchema.shape.lastPaymentDate.register(
		fieldRegistry,
		{
