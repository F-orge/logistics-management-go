...
const SurchargesActions = () => {
	...
	if (searchQuery.action === "create") {
		Component = {
			...
			description: "Fill out the form to create a new surcharges.",
			Element: <CreateForm />,
		};
	}
	...
	if (searchQuery.action === "update" && searchQuery.id) {
		Component = {
			...
			description: "Modify the surcharges details below.",
			Element: (
				<Suspense>
					<UpdateForm />
				</Suspense>
	...
	if (searchQuery.action === "delete" && searchQuery.id) {
		Component = {
			title: "Delete Surcharges",
			description: "Are you sure you want to delete this surcharges?",
			Element: <DeleteForm />,
		};
	}
