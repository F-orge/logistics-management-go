...
const AccountTransactionsActions = () => {
	...
	if (searchQuery.action === "create") {
		Component = {
			...
			description: "Fill out the form to create a new account transactions.",
			Element: <CreateForm />,
		};
	}
	...
	if (searchQuery.action === "delete" && searchQuery.id) {
		Component = {
			title: "Delete Account Transactions",
			description: "Are you sure you want to delete this account transactions?",
			Element: <DeleteForm />,
		};
	}
