...
const DisputesFormSchema = DisputesSchema.omit({
	id: true,
	created: true,
	updated: true,
});

export const DisputesActions = () => {
	...
	const { data } = useQuery({
		queryKey: ["disputess", searchQuery.id],
		enabled:
			!!searchQuery.id &&
	...
	if (searchQuery.action === "create") {
		return (
			<AutoForm<typeof DisputesFormSchema>
	...
	if (searchQuery.action === "update" && data) {
		return (
			<AutoForm<typeof DisputesFormSchema>
				...
				description="Update the disputes details."
	...
	if (searchQuery.action === "delete" && data) {
		return (
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						<AlertDialogTitle>Delete Disputes</AlertDialogTitle>
						<AlertDialogDescription>
							Are you sure you want to delete this disputes? This action cannot
							be undone.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
...
export default DisputesActions;
