...
const UpdateQuoteFormDialog = () => {
	...
	const { data: record } = useQuery({
		queryKey: [Collections.BillingManagementQuotes, searchParams.id],
		queryFn: () =>
			pocketbase
	...
	const form = useAppForm({
		defaultValues: (record ||
			{}) as Update<Collections.BillingManagementQuotes>,
	...
	return (
		<form.AppForm>
			<FormDialog
				open={searchParams.action === "updateQuote"}
				onOpenChange={() =>
					navigate({
...
export default UpdateQuoteFormDialog;
