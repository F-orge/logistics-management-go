...
const QuotesActions = () => {
	...
	if (searchQuery.action === "create") {
		Component = {
			title: "Create Quotes",
			description: "Fill out the form to create a new quotes.",
			Element: <CreateForm />,
		};
	}
	...
	if (searchQuery.action === "update" && searchQuery.id) {
		Component = {
			title: "Update Quotes",
			description: "Modify the quotes details below.",
			Element: (
				<Suspense>
					<UpdateForm />
				</Suspense>
	...
	if (searchQuery.action === "delete" && searchQuery.id) {
		Component = {
			title: "Delete Quotes",
			description: "Are you sure you want to delete this quotes?",
			Element: <DeleteForm />,
		};
	}
