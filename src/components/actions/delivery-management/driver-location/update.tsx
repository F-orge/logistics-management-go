...
import { DriverLocationForm, UpdateDriverLocationFormOption } from "./form";
...
const UpdateDriverLocationForm = () => {
  ...
  const form = useAppForm(UpdateDriverLocationFormOption(pocketbase, data));
  ...
  return (
    ...
    >
      <form.AppForm>
        <DriverLocationForm form={form as any} action="edit" />
        <DialogFooter>
