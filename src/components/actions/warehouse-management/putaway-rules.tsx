...
const PutawayRulesFormSchema = PutawayRulesSchema.omit({
  id: true,
  created: true,
  updated: true,
});

export const PutawayRulesActions = () => {
  ...
  const { data } = useQuery({
    queryKey: ["putaway-ruless", searchQuery.id],
    enabled:
      !!searchQuery.id &&
  ...
  if (searchQuery.action === "create") {
    return (
      <AutoForm<typeof PutawayRulesFormSchema>
  ...
  if (searchQuery.action === "update" && data) {
    return (
      <AutoForm<typeof PutawayRulesFormSchema>
        ...
        description="Update the putaway-rules details."
  ...
  if (searchQuery.action === "delete" && data) {
    return (
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete PutawayRules</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to delete this putaway-rules? This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
