...
const InventoryStockActions = () => {
	...
	if (searchQuery.action === "create") {
		Component = {
			...
			description: "Fill out the form to create a new inventory stock.",
			Element: <CreateForm />,
		};
	}
	...
	if (searchQuery.action === "update" && searchQuery.id) {
		Component = {
			...
			description: "Modify the inventory stock details below.",
			Element: (
				<Suspense>
					<UpdateForm />
				</Suspense>
	...
	if (searchQuery.action === "delete" && searchQuery.id) {
		Component = {
			...
			description: "Are you sure you want to delete this inventory stock?",
			Element: <DeleteForm />,
		};
	}
