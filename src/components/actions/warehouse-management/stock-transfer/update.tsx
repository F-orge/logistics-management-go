...
const UpdateStockTransferFormDialog = () => {
	...
	const form = useAppForm({
		defaultValues: (record ||
			{}) as Update<Collections.WarehouseManagementStockTransfer>,
	...
	return (
		<form.AppForm>
			<FormDialog
				open={searchParams.action === "updateStockTransfer"}
				onOpenChange={() =>
					navigate({
...
export default UpdateStockTransferFormDialog;
