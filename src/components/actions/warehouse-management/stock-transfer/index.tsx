...
const StockTransferActions = () => {
	...
	if (searchQuery.action === "create") {
		Component = {
			...
			description: "Fill out the form to create a new stock transfer.",
			Element: <CreateForm />,
		};
	}
	...
	if (searchQuery.action === "update" && searchQuery.id) {
		Component = {
			...
			description: "Modify the stock transfer details below.",
			Element: (
        <Suspense>
          <UpdateForm />
        </Suspense>
	...
	if (searchQuery.action === "delete" && searchQuery.id) {
		Component = {
			...
			description: "Are you sure you want to delete this stock transfer?",
			Element: <DeleteForm />,
		};
	}
