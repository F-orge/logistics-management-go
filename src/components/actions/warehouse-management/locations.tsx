...
const LocationsFormSchema = LocationsSchema.omit({
  id: true,
  created: true,
  updated: true,
});
...
export const LocationsActions = () => {
  ...
  const { data } = useQuery({
    queryKey: ["locationss", searchQuery.id],
    enabled:
      !!searchQuery.id &&
  ...
  if (searchQuery.action === "create") {
    return (
      <AutoForm<typeof LocationsFormSchema>
  ...
  if (searchQuery.action === "update" && data) {
    return (
      <AutoForm<typeof LocationsFormSchema>
        ...
        description="Update the locations details."
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this locations? This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
