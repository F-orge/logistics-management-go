...
const UpdatePutawayRuleFormDialog = () => {
	...
	const form = useAppForm({
		defaultValues: (record ||
			{}) as Update<Collections.WarehouseManagementPutawayRules>,
		onSubmit: async ({ value }) => {
			try {
				...
				toast.success("PutawayRule updated successfully");
			} catch (error) {
	...
	return (
		<form.AppForm>
			<FormDialog
				open={searchParams.action === "updatePutawayRule"}
				onOpenChange={() =>
					navigate({
...
export default UpdatePutawayRuleFormDialog;
