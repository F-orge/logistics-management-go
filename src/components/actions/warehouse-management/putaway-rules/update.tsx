...
export const UpdateSchema = z.object({
	...
	preferredLocation: PutawayRulesSchema.shape.preferredLocation.optional().register(fieldRegistry, {
	...
	locationType: PutawayRulesSchema.shape.locationType.optional().register(fieldRegistry, {
	...
	priority: PutawayRulesSchema.shape.priority.optional().register(fieldRegistry, {
	...
	minQuantity: PutawayRulesSchema.shape.minQuantity.optional().register(fieldRegistry, {
	...
	maxQuantity: PutawayRulesSchema.shape.maxQuantity.optional().register(fieldRegistry, {
	...
	weightThreshold: PutawayRulesSchema.shape.weightThreshold.optional().register(fieldRegistry, {
	...
	volumeThreshold: PutawayRulesSchema.shape.volumeThreshold.optional().register(fieldRegistry, {
	...
	requireTemperatureControl: PutawayRulesSchema.shape.requireTemperatureControl.optional().register(fieldRegistry, {
	...
	requireHazmatApproval: PutawayRulesSchema.shape.requireHazmatApproval.optional().register(fieldRegistry, {
	...
	isActive: PutawayRulesSchema.shape.isActive.optional().register(fieldRegistry, {
