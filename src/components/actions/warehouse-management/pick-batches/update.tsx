...
const UpdatePickBatchFormDialog = () => {
	...
	const form = useAppForm({
		defaultValues: (record ||
			{}) as Update<Collections.WarehouseManagementPickBatches>,
		onSubmit: async ({ value }) => {
			try {
				...
				toast.success("PickBatch updated successfully");
			} catch (error) {
	...
	return (
		<form.AppForm>
			<FormDialog
				open={searchParams.action === "updatePickBatch"}
				onOpenChange={() =>
					navigate({
...
export default UpdatePickBatchFormDialog;
