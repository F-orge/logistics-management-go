...
const PackageItemsFormSchema = PackageItemsSchema.omit({
  id: true,
  created: true,
  updated: true,
});

export const PackageItemsActions = () => {
  ...
  const { data } = useQuery({
    queryKey: ["package-itemss", searchQuery.id],
    enabled:
      !!searchQuery.id &&
  ...
  if (searchQuery.action === "create") {
    return (
      <AutoForm<typeof PackageItemsFormSchema>
  ...
  if (searchQuery.action === "update" && data) {
    return (
      <AutoForm<typeof PackageItemsFormSchema>
        ...
        description="Update the package-items details."
  ...
  if (searchQuery.action === "delete" && data) {
    return (
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete PackageItems</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to delete this package-items? This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
