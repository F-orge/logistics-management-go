...
const UpdatePackageFormDialog = () => {
	...
	const { data: record } = useQuery({
		queryKey: [Collections.WarehouseManagementPackages, searchParams.id],
		queryFn: () =>
			pocketbase
	...
	const form = useAppForm({
		defaultValues: (record ||
			{}) as Update<Collections.WarehouseManagementPackages>,
	...
	return (
		<form.AppForm>
			<FormDialog
				open={searchParams.action === "updatePackage"}
				onOpenChange={() =>
					navigate({
...
export default UpdatePackageFormDialog;
