...
const SuppliersFormSchema = SuppliersSchema.omit({
	id: true,
	created: true,
	updated: true,
});
...
export const SuppliersActions = () => {
	...
	const { data } = useQuery({
		queryKey: ["supplierss", searchQuery.id],
		enabled:
			!!searchQuery.id &&
	...
	if (searchQuery.action === "create") {
		return (
			<AutoForm<typeof SuppliersFormSchema>
	...
	if (searchQuery.action === "update" && data) {
		return (
			<AutoForm<typeof SuppliersFormSchema>
				...
				description="Update the suppliers details."
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Are you sure you want to delete this suppliers? This action cannot
							be undone.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
