...
const NotificationsFormSchema = NotificationsSchema.omit({
  id: true,
  created: true,
  updated: true,
});
...
export const NotificationsActions = () => {
  ...
  const { data } = useQuery({
    queryKey: ["notificationss", searchQuery.id],
    enabled:
      !!searchQuery.id &&
  ...
  if (searchQuery.action === "create") {
    return (
      <AutoForm<typeof NotificationsFormSchema>
  ...
  if (searchQuery.action === "update" && data) {
    return (
      <AutoForm<typeof NotificationsFormSchema>
        ...
        description="Update the notifications details."
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this notifications? This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
