...
const DeleteInteractionFormDialog = () => {
	...
	const handleDelete = async () => {
		if (!searchParams.id) {
			toast.error("No Interaction selected");
			return;
		}
	...
	return (
		<AlertDialog
			open={searchParams.action === "deleteInteraction"}
			onOpenChange={(open) => {
				if (!open) {
					navigate({
						search: (prev) => ({
...
export default DeleteInteractionFormDialog;
