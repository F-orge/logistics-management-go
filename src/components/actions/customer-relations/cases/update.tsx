...
const UpdateCaseFormDialog = () => {
	...
	const { data: record } = useQuery({
		queryKey: [Collections.CustomerRelationsCases, searchParams.id],
		queryFn: () =>
			pocketbase
	...
	return (
		<form.AppForm>
			<FormDialog
				open={searchParams.action === "updateCase"}
				onOpenChange={() =>
					navigate({
				...
				title="Update Case"
				description="Edit case information"
			>
				<FieldSet>
					{/* Case Type & Priority */}
					<FieldGroup>
...
export default UpdateCaseFormDialog;
