...
const CarrierRatesActions = () => {
	...
	if (searchQuery.action === "create") {
		Component = {
			title: "Create Carrier Rate",
			description: "Fill out the form to create a new carrier rate.",
			Element: <CreateForm />,
		};
	}
	...
	if (searchQuery.action === "update" && searchQuery.id) {
		Component = {
			...
			description: "Modify the carrier rate details below.",
			Element: (
				<Suspense>
					<UpdateForm />
				</Suspense>
	...
	if (searchQuery.action === "delete" && searchQuery.id) {
		Component = {
			...
			description: "Are you sure you want to delete this carrier rate?",
			Element: <DeleteForm />,
		};
	}
