...
import { GeofenceSchema } from "@/pocketbase/schemas/transport-management";
...
const FormOption = formOptions({
  ...
  onSubmit: async ({ value, meta }) => {
    try {
      await meta
        .pocketbase!.collection(Collections.TransportManagementGeofence)
  ...
  return (
    ...
    >
      <form.AppForm>
        ...
        />
        <DialogFooter>
          <form.SubmitButton>Update Geofence</form.SubmitButton>
        </DialogFooter>
      </form.AppForm>
    </form>
  );
