...
const DriversFormSchema = DriversSchema.omit({
	id: true,
	created: true,
	updated: true,
});
...
export const DriversActions = () => {
	...
	const { data } = useQuery({
		queryKey: ["driverss", searchQuery.id],
		enabled:
			!!searchQuery.id &&
	...
	if (searchQuery.action === "create") {
		return (
			<AutoForm<typeof DriversFormSchema>
	...
	if (searchQuery.action === "update" && data) {
		return (
			<AutoForm<typeof DriversFormSchema>
				...
				description="Update the drivers details."
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Are you sure you want to delete this drivers? This action cannot
							be undone.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
