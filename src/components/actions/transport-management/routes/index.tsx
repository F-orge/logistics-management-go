...
const RoutesActions = () => {
	...
	if (searchQuery.action === "create") {
		Component = {
			title: "Create Routes",
			description: "Fill out the form to create a new routes.",
			Element: <CreateForm />,
		};
	}
	...
	if (searchQuery.action === "update" && searchQuery.id) {
		Component = {
			title: "Update Routes",
			description: "Modify the routes details below.",
			Element: (
				<Suspense>
					<UpdateForm />
				</Suspense>
	...
	if (searchQuery.action === "delete" && searchQuery.id) {
		Component = {
			title: "Delete Routes",
			description: "Are you sure you want to delete this routes?",
			Element: <DeleteForm />,
		};
	}
