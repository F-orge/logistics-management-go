...
const ShipmentLegEventsFormSchema = ShipmentLegEventsSchema.omit({
  id: true,
  created: true,
  updated: true,
});

export const ShipmentLegEventsActions = () => {
  ...
  const { data } = useQuery({
    queryKey: ["shipment-leg-eventss", searchQuery.id],
    enabled:
      !!searchQuery.id &&
  ...
  if (searchQuery.action === "create") {
    return (
      <AutoForm<typeof ShipmentLegEventsFormSchema>
        ...
        schema={ShipmentLegEventsFormSchema}
      />
    );
  }
  ...
  if (searchQuery.action === "update" && data) {
    return (
      <AutoForm<typeof ShipmentLegEventsFormSchema>
        ...
        description="Update the shipment-leg-events details."
  ...
  if (searchQuery.action === "delete" && data) {
    return (
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete ShipmentLegEvents</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to delete this shipment-leg-events? This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
...
export default ShipmentLegEventsActions;
