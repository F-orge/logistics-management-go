...
const PartnerInvoiceFormSchema = PartnerInvoiceSchema.omit({
  id: true,
  created: true,
  updated: true,
});

export const PartnerInvoiceActions = () => {
  ...
  const { data } = useQuery({
    queryKey: ["partner-invoices", searchQuery.id],
    enabled:
      !!searchQuery.id &&
  ...
  if (searchQuery.action === "create") {
    return (
      <AutoForm<typeof PartnerInvoiceFormSchema>
        ...
        schema={PartnerInvoiceFormSchema}
      />
    );
  }
  ...
  if (searchQuery.action === "update" && data) {
    return (
      <AutoForm<typeof PartnerInvoiceFormSchema>
        ...
        description="Update the partner-invoice details."
  ...
  if (searchQuery.action === "delete" && data) {
    return (
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete PartnerInvoice</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to delete this partner-invoice? This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
...
export default PartnerInvoiceActions;
