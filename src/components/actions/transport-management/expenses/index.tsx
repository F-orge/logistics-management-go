...
const ExpensesActions = () => {
	...
	if (searchQuery.action === "create") {
		Component = {
			...
			description: "Fill out the form to create a new expenses.",
			Element: <CreateForm />,
		};
	}
	...
	if (searchQuery.action === "update" && searchQuery.id) {
		Component = {
			...
			description: "Modify the expenses details below.",
			Element: <UpdateForm />,
		};
	}
	...
	if (searchQuery.action === "delete" && searchQuery.id) {
		Component = {
			...
			description: "Are you sure you want to delete this expenses?",
			Element: <DeleteForm />,
		};
	}
