...
const SurchargeControls = () => {
  ...
  const [calculationMethodFilter, setCalculationMethodFilter] = React.useState("");
  ...
  const handleSearch = () => {
    ...
    if (calculationMethodFilter) filters.push(`calculationMethod = '${calculationMethodFilter}'`);
