			...
			navigation: [
				{
					...
					items: [
						...
						},
						{
							...
							icon: Settings2,
							url: "/dashboard/warehouse-management/inventory-adjustments",
						},
					],
				},
				{
					...
					items: [
						...
						},
						{
							...
							icon: SquareTerminal,
							url: "/dashboard/warehouse-management/stock-transfers",
						},
						{
							title: "Returns",
							icon: BookOpen,
				...
				},
				{
					...
					items: [
						...
						},
						{
							...
							icon: Frame,
							url: "/dashboard/warehouse-management/bin-thresholds",
						},
						{
							title: "Putaway Rules",
							icon: Command,
				...
				},
				{
					...
					items: [
						...
						},
						{
							...
							icon: FileText,
							url: "/dashboard/billing-management/accounting-sync-log",
						},
					],
				},
			],
				...
				},
				{
					...
					items: [
						...
						},
						{
							title: "Geofences",
							icon: Frame,
							url: "/dashboard/transport-management/geofences",
						},
					],
				},
				{
					...
					items: [
						...
						},
						{
							...
							icon: FileText,
							url: "/dashboard/transport-management/partner-invoices",
						},
					],
				},
			],
					...
					items: [
						{
							...
							icon: Command,
							url: "/dashboard/delivery-management/delivery-tasks",
						},
						{
							title: "Delivery Routes",
							icon: MapIcon,
							url: "/dashboard/delivery-management/delivery-routes",
						},
						{
							title: "Tasks",
							icon: Command,
			...
			navigation: [
				{
					...
					items: [
						...
						},
						{
							...
							icon: Link,
							url: "/dashboard/delivery-management/customer-tracking-links",
						},
					],
				},
			],
