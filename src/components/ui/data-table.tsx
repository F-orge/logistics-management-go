...
export function DataTable<TData, TValue>({
	...
	return (
		<div className="space-y-4">
			...
			{data.totalPages > 1 && (
				<div className="flex flex-col items-center justify-center gap-2 sm:gap-4 sm:flex-row sm:justify-between">
					...
					<Pagination className="w-full">
						<PaginationContent className="w-full justify-center sm:justify-end gap-1 sm:gap-2">
							<PaginationItem>
								<PaginationPrevious
									onClick={async () => {
