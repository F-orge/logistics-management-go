...
export const AccountTransactionInsertSchema =
  AccountTransactionSchema.omit({
    id: true,
    createdAt: true,
    updatedAt: true,
  });

export const AccountTransactionUpdateSchema =
  AccountTransactionInsertSchema.partial().strict();
