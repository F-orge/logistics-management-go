...
import {
  InvoiceLineItemInsertSchema,
  InvoiceLineItemSchema,
  InvoiceLineItemUpdateSchema,
...
describe('BillingInvoiceLineItemSchema Validation', () => {
  describe('Valid Cases', () => {
    ...
    test.each(validTestCases)('should validate: $name', ({ input }) => {
      expect(() => InvoiceLineItemSchema.parse(input)).not.toThrow()
      const result = InvoiceLineItemSchema.parse(input)
  ...
  describe('Invalid Cases', () => {
    ...
    test.each(invalidTestCases)('should reject: $name', ({ input, expectedError }) => {
      ...
      try {
        InvoiceLineItemSchema.parse(input)
      } catch (e) {
  ...
  describe('SafeParse Tests for InvoiceLineItemSchema', () => {
...
describe('BillingInvoiceLineItemInsertSchema Validation', () => {
  describe('Valid Cases', () => {
    ...
    test.each(validTestCases)('should validate: $name', ({ input }) => {
      expect(() => InvoiceLineItemInsertSchema.parse(input)).not.toThrow()
      const result = InvoiceLineItemInsertSchema.parse(input)
      expect(result).toEqual(expect.objectContaining(input))
    })
  })
  ...
  describe('Invalid Cases', () => {
    ...
    test.each(invalidTestCases)('should reject: $name', ({ input, expectedError }) => {
      let error: ZodError | undefined
      try {
        InvoiceLineItemInsertSchema.parse(input)
      } catch (e) {
        if (e instanceof ZodError) {
          error = e
        }
  ...
  describe('SafeParse Tests for InvoiceLineItemInsertSchema', () => {
    test('should return success for valid data', () => {
      const validData = {
        description: 'New Service Fee',
        invoiceId: '123e4567-e89b-12d3-a456-426614174000',
      ...
      const result = InvoiceLineItemInsertSchema.safeParse(validData)
    ...
    test('should return error for invalid data', () => {
      ...
      const result = InvoiceLineItemInsertSchema.safeParse(invalidData)
...
describe('BillingInvoiceLineItemUpdateSchema Validation', () => {
  describe('Valid Cases', () => {
    ...
    test.each(validTestCases)('should validate: $name', ({ input }) => {
      expect(() => InvoiceLineItemUpdateSchema.parse(input)).not.toThrow()
      const result = InvoiceLineItemUpdateSchema.parse(input)
      expect(result).toEqual(expect.objectContaining(input))
    })
  })
  ...
  describe('Invalid Cases', () => {
    ...
    test.each(invalidTestCases)('should reject: $name', ({ input, expectedError }) => {
      let error: ZodError | undefined
      try {
        InvoiceLineItemUpdateSchema.parse(input)
      } catch (e) {
        if (e instanceof ZodError) {
          error = e
        }
  ...
  describe('SafeParse Tests for InvoiceLineItemUpdateSchema', () => {
    test('should return success for valid data', () => {
      const validData = {
        description: 'Updated Service Fee',
      }
      const result = InvoiceLineItemUpdateSchema.safeParse(validData)
    ...
    test('should return error for invalid data', () => {
      ...
      const result = InvoiceLineItemUpdateSchema.safeParse(invalidData)
