...
export type WmsTaskItem = z.infer<typeof TaskItemSchema>

export const TaskItemInsertSchema = TaskItemSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
})

export const TaskItemUpdateSchema = TaskItemInsertSchema.partial()
