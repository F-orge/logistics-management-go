...
export const AttachmentRepository = repositoryFactory('crm.attachments', AttachmentSchema)

export const CampaignRepository = repositoryFactory('crm.campaigns', CampaignSchema)
...
export const InteractionRepository = repositoryFactory('crm.interactions', InteractionSchema)

export const InvoiceRepository = repositoryFactory('crm.invoices', InvoiceSchema)
export const InvoiceItemRepository = repositoryFactory('crm.invoiceItems', InvoiceItemSchema)
export const LeadRepository = repositoryFactory('crm.leads', LeadSchema)
export const NotificationRepository = repositoryFactory('crm.notifications', NotificationSchema)
export const OpportunityRepository = repositoryFactory('crm.opportunities', OpportunitySchema)
