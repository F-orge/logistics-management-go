...
export const CreditNoteRepository = repositoryFactory(
  'billing.creditNotes',
  CreditNoteSchema,
);
export const DisputeRepository = repositoryFactory(
  'billing.disputes',
  DisputeSchema,
);
export const DocumentRepository = repositoryFactory(
  'billing.documents',
  DocumentSchema,
);
...
export const RateCardRepository = repositoryFactory(
  'billing.rateCards',
  RateCardSchema,
);
export const RateRuleRepository = repositoryFactory(
  'billing.rateRules',
  RateRuleSchema,
);
export const SurchargeRepository = repositoryFactory(
  'billing.surcharges',
  SurchargeSchema,
);
