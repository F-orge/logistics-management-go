...
export const BinThresholdRepository = repositoryFactory(
  'wms.binThresholds',
  BinThresholdSchema,
);
...
export const PackageItemRepository = repositoryFactory(
  'wms.packageItems',
  PackageItemSchema,
);
export const PickBatchRepository = repositoryFactory(
  'wms.pickBatches',
  PickBatchSchema,
);
export const PickBatchItemRepository = repositoryFactory(
  'wms.pickBatchItems',
  PickBatchItemSchema,
);
export const ProductRepository = repositoryFactory('wms.products', ProductSchema);
export const PutawayRuleRepository = repositoryFactory(
  'wms.putawayRules',
  PutawayRuleSchema,
);
export const ReorderPointRepository = repositoryFactory(
  'wms.reorderPoints',
  ReorderPointSchema,
);
export const ReturnRepository = repositoryFactory('wms.returns', ReturnSchema);
export const ReturnItemRepository = repositoryFactory(
  'wms.returnItems',
  ReturnItemSchema,
);
export const SalesOrderRepository = repositoryFactory(
  'wms.salesOrders',
  SalesOrderSchema,
);
...
export const StockTransferRepository = repositoryFactory(
  'wms.stockTransfers',
  StockTransferSchema,
);
