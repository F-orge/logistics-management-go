...
export const DeliveryRouteRepository = repositoryFactory('dms.deliveryRoutes', DeliveryRouteSchema)
export const DeliveryTaskRepository = repositoryFactory('dms.deliveryTasks', DeliveryTaskSchema)
...
export const TaskEventRepository = repositoryFactory('dms.taskEvents', TaskEventSchema)
