...
export const CarrierRateRepository = repositoryFactory('tms.carrierRates', CarrierRateSchema)
...
export const GeofenceEventRepository = repositoryFactory('tms.geofenceEvents', GeofenceEventSchema)
...
export const ShipmentLegRepository = repositoryFactory('tms.shipmentLegs', ShipmentLegSchema)
