...
type CreateSchema = z.infer<
	ReturnType<typeof CreateVehicleMaintenanceInputSchema>
>;
type UpdateSchema = z.infer<
	ReturnType<typeof UpdateVehicleMaintenanceInputSchema>
>;
...
describe("Vehicle Maintenance Inputs", () => {
	describe("CreateVehicleMaintenanceInputSchema", () => {
		describe("Valid Cases", () => {
			...
			it.each(cases)("should validate: $name", (testCase) => {
				const { success } = CreateVehicleMaintenanceInputSchema().safeParse(
					testCase.input,
				);
	...
	describe("UpdateVehicleMaintenanceInputSchema", () => {
		describe("Valid Cases", () => {
			...
			it.each(cases)("should validate: $name", (testCase) => {
				const { success } = UpdateVehicleMaintenanceInputSchema().safeParse(
					testCase.input,
				);
