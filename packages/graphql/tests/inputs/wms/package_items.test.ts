...
type CreateSchema = z.infer<ReturnType<typeof CreatePackageItemInputSchema>>;

type UpdateSchema = z.infer<ReturnType<typeof UpdatePackageItemInputSchema>>;
...
describe("Package Item Inputs", () => {
	describe("Create Schema", () => {
		describe("Valid Cases", () => {
			...
			it.each(cases)("should validate: $name", (testCase) => {
				const { success } = CreatePackageItemInputSchema().safeParse(
					testCase.input,
				);
		...
		describe("Invalid Cases", () => {
			...
			it.each(cases)("should reject: $name", (testCase) => {
				const { error } = CreatePackageItemInputSchema().safeParse(
					testCase.input,
				);
	...
	describe("Update Schema", () => {
		describe("Valid Cases", () => {
			...
			it.each(cases)("should validate: $name", (testCase) => {
				const { success } = UpdatePackageItemInputSchema().safeParse(
					testCase.input,
				);
		...
		describe("Invalid Cases", () => {
			...
			it.each(cases)("should reject: $name", (testCase) => {
				const { error } = UpdatePackageItemInputSchema().safeParse(
					testCase.input,
				);
