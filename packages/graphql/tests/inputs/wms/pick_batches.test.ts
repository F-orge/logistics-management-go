...
type CreateSchema = z.infer<ReturnType<typeof CreatePickBatchInputSchema>>;

type UpdateSchema = z.infer<ReturnType<typeof UpdatePickBatchInputSchema>>;
...
describe("Pick Batch Inputs", () => {
	describe("Create Schema", () => {
		describe("Valid Cases", () => {
			...
			it.each(cases)("should validate: $name", (testCase) => {
				const { success } = CreatePickBatchInputSchema().safeParse(
					testCase.input,
				);
		...
		describe("Invalid Cases", () => {
			...
			it.each(cases)("should reject: $name", (testCase) => {
				const { error } = CreatePickBatchInputSchema().safeParse(
					testCase.input,
				);
	...
	describe("Update Schema", () => {
		describe("Valid Cases", () => {
			...
			it.each(cases)("should validate: $name", (testCase) => {
				const { success } = UpdatePickBatchInputSchema().safeParse(
					testCase.input,
				);
		...
		describe("Invalid Cases", () => {
			...
			it.each(cases)("should reject: $name", (testCase) => {
				const { error } = UpdatePickBatchInputSchema().safeParse(
					testCase.input,
				);
