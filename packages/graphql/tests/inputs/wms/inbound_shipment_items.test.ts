...
type CreateSchema = z.infer<
	ReturnType<typeof CreateInboundShipmentItemInputSchema>
>;

type UpdateSchema = z.infer<
	ReturnType<typeof UpdateInboundShipmentItemInputSchema>
>;
...
describe("Inbound Shipment Item Inputs", () => {
	describe("Create Schema", () => {
		...
		describe("Invalid Cases", () => {
			...
			it.each(cases)("should reject: $name", (testCase) => {
				const { error } = CreateInboundShipmentItemInputSchema().safeParse(
					testCase.input,
				);
	...
	describe("Update Schema", () => {
		...
		describe("Invalid Cases", () => {
			...
			it.each(cases)("should reject: $name", (testCase) => {
				const { error } = UpdateInboundShipmentItemInputSchema().safeParse(
					testCase.input,
				);
