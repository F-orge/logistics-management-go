...
type CreateSchema = z.infer<ReturnType<typeof CreateSurchargeInputSchema>>;

type UpdateSchema = z.infer<ReturnType<typeof UpdateSurchargeInputSchema>>;
...
describe("Surcharge Inputs", () => {
	describe("Create Schema", () => {
		describe("Valid Cases", () => {
			...
			it.each(cases)("should validate: $name", (testCase) => {
				const { success } = CreateSurchargeInputSchema().safeParse(
					testCase.input,
				);
		...
		describe("Invalid Cases", () => {
			...
			it.each(cases)("should reject: $name", (testCase) => {
				const { error } = CreateSurchargeInputSchema().safeParse(
					testCase.input,
				);
	...
	describe("Update Schema", () => {
		describe("Valid Cases", () => {
			...
			it.each(cases)("should validate: $name", (testCase) => {
				const { success } = UpdateSurchargeInputSchema().safeParse(
					testCase.input,
				);
		...
		describe("Invalid Cases", () => {
			...
			it.each(cases)("should reject: $name", (testCase) => {
				const { error } = UpdateSurchargeInputSchema().safeParse(
					testCase.input,
				);
