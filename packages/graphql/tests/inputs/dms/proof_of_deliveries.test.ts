...
type CreateSchema = z.infer<ReturnType<typeof CreateProofOfDeliveryInputSchema>>;
type UpdateSchema = z.infer<ReturnType<typeof UpdateProofOfDeliveryInputSchema>>;
  ...
  describe("CreateProofOfDeliveryInputSchema", () => {
    ...
    describe("SafeParse Tests", () => {
      ...
      it("should return error when tripStopId is missing", () => {
        ...
        const result = CreateProofOfDeliveryInputSchema().safeParse(invalidData);
  ...
  describe("UpdateProofOfDeliveryInputSchema", () => {
    ...
    describe("SafeParse Tests", () => {
      ...
      it("should return error for invalid type enum", () => {
        ...
        const result = UpdateProofOfDeliveryInputSchema().safeParse(invalidData);
