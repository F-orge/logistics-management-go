      ...
      const cases: TestCase<Partial<CreateSchema>>[] = [
        ...
        },
        {
          ...
          input: {
            ...
            status: "DELIVERED",
            notes: "Delivered to secure location behind main entrance as per customer instructions. Recipient verified identity before receiving package. Package condition verified as intact.",
          },
          success: true,
        },
        {
