...
export const CarrierRateUnitSchema = z.enum([
	"FLAT_RATE",
	"PER_CONTAINER",
	"PER_KG",
	"PER_KM",
...
export const CrmInvoicePaymentMethodSchema = z.enum([
	"BANK_TRANSFER",
	"CASH",
	"CHECK",
	"CREDIT_CARD",
...
export const DeliveryRouteStatusSchema = z.enum([
	"CANCELLED",
	"COMPLETED",
	"IN_PROGRESS",
	"PAUSED",
...
export const DriverScheduleReasonSchema = z.enum([
	"PERSONAL_LEAVE",
	"SICK_LEAVE",
	"TRAINING",
	"VACATION",
...
export const InboundShipmentStatusSchema = z.enum([
	"ARRIVED",
	"CANCELLED",
	"COMPLETED",
	"PENDING",
...
export const OutboundShipmentStatusSchema = z.enum([
	"CANCELLED",
	"DELIVERED",
	"PACKED",
	"PICKING",
...
export const PartnerInvoiceStatusSchema = z.enum([
	"CANCELLED",
	"DISPUTED",
	"OVERDUE",
	"PAID",
...
export const PickBatchStatusSchema = z.enum([
	"CANCELLED",
	"COMPLETED",
	"IN_PROGRESS",
	"OPEN",
...
export const PickStrategySchema = z.enum([
	"BATCH_PICKING",
	"CLUSTER_PICKING",
	"SINGLE_ORDER_PICKING",
	"WAVE_PICKING",
...
export const ProofOfDeliveryTypeSchema = z.enum([
	"CODE_VERIFICATION",
	"CONTACTLESS_DELIVERY",
	"LEFT_AT_DOOR",
	"PHOTO",
...
export const ShipmentLegStatusSchema = z.enum([
	"CANCELLED",
	"DELIVERED",
	"FAILED",
	"IN_TRANSIT",
...
export const SurchargeCalculationMethodSchema = z.enum([
	"FIXED",
	"PERCENTAGE",
	"PER_UNIT",
	"SLIDING_SCALE",
...
export const TaskEventStatusSchema = z.enum([
	"ARRIVED",
	"ASSIGNED",
	"CANCELLED",
	"DELIVERED",
...
export const TripStopStatusSchema = z.enum([
	"ARRIVED",
	"COMPLETED",
	"PENDING",
	"SKIPPED",
...
export function AddInvoiceItemInputSchema(): z.ZodObject<
	Properties<AddInvoiceItemInput>
> {
	return z.object({
		productId: z.string(),
...
export function AddOpportunityProductInputSchema(): z.ZodObject<
	Properties<AddOpportunityProductInput>
> {
	return z.object({
		productId: z.string(),
		quantity: z.number().min(0.01),
...
export function CreateAccountTransactionInputSchema(): z.ZodObject<
	Properties<CreateAccountTransactionInput>
> {
	return z.object({
...
export function CreateAccountingSyncLogInputSchema(): z.ZodObject<
	Properties<CreateAccountingSyncLogInput>
> {
	return z.object({
...
export function CreateAttachmentInputSchema(): z.ZodObject<
	Properties<CreateAttachmentInput>
> {
	return z.object({
		file: z.file(),
		recordId: z.string(),
...
export function CreateBillingInvoiceInputSchema(): z.ZodObject<
	Properties<CreateBillingInvoiceInput>
> {
	return z.object({
		clientId: z.string(),
...
export function CreateBinThresholdInputSchema(): z.ZodObject<
	Properties<CreateBinThresholdInput>
> {
	return z.object({
...
export function CreateCampaignInputSchema(): z.ZodObject<
	Properties<CreateCampaignInput>
> {
	return z.object({
...
export function CreateCarrierInputSchema(): z.ZodObject<
	Properties<CreateCarrierInput>
> {
	return z.object({
...
export function CreateCarrierRateInputSchema(): z.ZodObject<
	Properties<CreateCarrierRateInput>
> {
	return z.object({
		carrierId: z.string(),
...
export function CreateCaseInputSchema(): z.ZodObject<
	Properties<CreateCaseInput>
> {
	return z.object({
...
export function CreateClientAccountInputSchema(): z.ZodObject<
	Properties<CreateClientAccountInput>
> {
	return z.object({
...
export function CreateCompanyInputSchema(): z.ZodObject<
	Properties<CreateCompanyInput>
> {
	return z.object({
...
export function CreateCreditNoteInputSchema(): z.ZodObject<
	Properties<CreateCreditNoteInput>
> {
	return z.object({
		amount: z.number().min(0),
...
export function CreateCustomerTrackingLinkInputSchema(): z.ZodObject<
	Properties<CreateCustomerTrackingLinkInput>
> {
	return z.object({
...
export function CreateDeliveryRouteInputSchema(): z.ZodObject<
	Properties<CreateDeliveryRouteInput>
> {
	return z.object({
		driverId: z.string(),
...
export function CreateDeliveryTaskInputSchema(): z.ZodObject<
	Properties<CreateDeliveryTaskInput>
> {
	return z.object({
...
export function CreateDisputeInputSchema(): z.ZodObject<
	Properties<CreateDisputeInput>
> {
	return z.object({
		clientId: z.string(),
...
export function CreateDmsProofOfDeliveryInputSchema(): z.ZodObject<
	Properties<CreateDmsProofOfDeliveryInput>
> {
	return z.object({
		deliveryTaskId: z.string(),
...
export function CreateDocumentInputSchema(): z.ZodObject<
	Properties<CreateDocumentInput>
> {
	return z.object({
...
export function CreateDriverInputSchema(): z.ZodObject<
	Properties<CreateDriverInput>
> {
	return z.object({
		contactPhone: z.string().min(1).optional(),
...
export function CreateDriverLocationInputSchema(): z.ZodObject<
	Properties<CreateDriverLocationInput>
> {
	return z.object({
...
export function CreateDriverScheduleInputSchema(): z.ZodObject<
	Properties<CreateDriverScheduleInput>
> {
	return z.object({
		driverId: z.string(),
...
export function CreateExpenseInputSchema(): z.ZodObject<
	Properties<CreateExpenseInput>
> {
	return z.object({
		amount: z.number().min(0),
...
export function CreateGeofenceEventInputSchema(): z.ZodObject<
	Properties<CreateGeofenceEventInput>
> {
	return z.object({
...
export function CreateGeofenceInputSchema(): z.ZodObject<
	Properties<CreateGeofenceInput>
> {
	return z.object({
		latitude: z.number().min(-90).max(90).optional(),
		longitude: z.number().min(-180).max(180).optional(),
...
export function CreateGpsPingInputSchema(): z.ZodObject<
	Properties<CreateGpsPingInput>
> {
	return z.object({
		latitude: z.number().min(-90).max(90),
		longitude: z.number().min(-180).max(180),
...
export function CreateInboundShipmentInputSchema(): z.ZodObject<
	Properties<CreateInboundShipmentInput>
> {
	return z.object({
...
export function CreateInboundShipmentItemInputSchema(): z.ZodObject<
	Properties<CreateInboundShipmentItemInput>
> {
	return z.object({
...
export function CreateInteractionInputSchema(): z.ZodObject<
	Properties<CreateInteractionInput>
> {
	return z.object({
...
export function CreateInventoryAdjustmentInputSchema(): z.ZodObject<
	Properties<CreateInventoryAdjustmentInput>
> {
	return z.object({
		notes: z.string().min(1).optional(),
		productId: z.string(),
...
export function CreateInventoryBatchInputSchema(): z.ZodObject<
	Properties<CreateInventoryBatchInput>
> {
	return z.object({
...
export function CreateInventoryStockInputSchema(): z.ZodObject<
	Properties<CreateInventoryStockInput>
> {
	return z.object({
...
export function CreateInvoiceItemInputSchema(): z.ZodObject<
	Properties<CreateInvoiceItemInput>
> {
	return z.object({
		productId: z.string(),
		quantity: z.number().min(0.01),
...
export function CreateInvoiceLineItemInputSchema(): z.ZodObject<
	Properties<CreateInvoiceLineItemInput>
> {
	return z.object({
...
export function CreateLeadInputSchema(): z.ZodObject<
	Properties<CreateLeadInput>
> {
	return z.object({
...
export function CreateLocationInputSchema(): z.ZodObject<
...
export function CreateNotificationInputSchema(): z.ZodObject<
	Properties<CreateNotificationInput>
> {
	return z.object({
...
export function CreateOpportunityInputSchema(): z.ZodObject<
	Properties<CreateOpportunityInput>
> {
	return z.object({
		campaignId: z.string().optional(),
...
export function CreateOpportunityProductInputSchema(): z.ZodObject<
	Properties<CreateOpportunityProductInput>
> {
	return z.object({
		productId: z.string(),
		quantity: z.number().min(0.01),
...
export function CreateOutboundShipmentInputSchema(): z.ZodObject<
	Properties<CreateOutboundShipmentInput>
> {
	return z.object({
...
export function CreateOutboundShipmentItemInputSchema(): z.ZodObject<
	Properties<CreateOutboundShipmentItemInput>
> {
	return z.object({
		batchId: z.string().optional(),
		productId: z.string(),
...
export function CreatePackageInputSchema(): z.ZodObject<
	Properties<CreatePackageInput>
> {
	return z.object({
		carrier: z.string().min(1).optional(),
...
export function CreatePackageItemInputSchema(): z.ZodObject<
	Properties<CreatePackageItemInput>
> {
	return z.object({
		batchId: z.string().optional(),
...
export function CreatePartnerInvoiceInputSchema(): z.ZodObject<
	Properties<CreatePartnerInvoiceInput>
> {
	return z.object({
		carrierId: z.string(),
...
export function CreatePartnerInvoiceItemInputSchema(): z.ZodObject<
	Properties<CreatePartnerInvoiceItemInput>
> {
	return z.object({
		amount: z.number(),
...
export function CreatePaymentInputSchema(): z.ZodObject<
	Properties<CreatePaymentInput>
> {
	return z.object({
		amount: z.number().min(0),
		currency: z.string().min(1).optional(),
...
export function CreatePickBatchInputSchema(): z.ZodObject<
	Properties<CreatePickBatchInput>
> {
	return z.object({
...
export function CreatePickBatchItemInputSchema(): z.ZodObject<
	Properties<CreatePickBatchItemInput>
> {
	return z.object({
...
export function CreateProofOfDeliveryInputSchema(): z.ZodObject<
	Properties<CreateProofOfDeliveryInput>
> {
	return z.object({
...
export function CreatePutawayRuleInputSchema(): z.ZodObject<
	Properties<CreatePutawayRuleInput>
> {
	return z.object({
		clientId: z.string().optional(),
		isActive: z.boolean().optional(),
...
export function CreateQuoteInputSchema(): z.ZodObject<
	Properties<CreateQuoteInput>
> {
	return z.object({
		clientId: z.string().optional(),
		createdByUserId: z.string().optional(),
...
export function CreateRateCardInputSchema(): z.ZodObject<
	Properties<CreateRateCardInput>
> {
	return z.object({
		createdByUserId: z.string().optional(),
		description: z.string().min(1).optional(),
...
export function CreateRateRuleInputSchema(): z.ZodObject<
	Properties<CreateRateRuleInput>
> {
	return z.object({
...
export function CreateReorderPointInputSchema(): z.ZodObject<
	Properties<CreateReorderPointInput>
> {
	return z.object({
		productId: z.string(),
...
export function CreateReturnInputSchema(): z.ZodObject<
	Properties<CreateReturnInput>
> {
	return z.object({
		clientId: z.string(),
...
export function CreateReturnItemInputSchema(): z.ZodObject<
	Properties<CreateReturnItemInput>
> {
	return z.object({
...
export function CreateRouteInputSchema(): z.ZodObject<
	Properties<CreateRouteInput>
> {
	return z.object({
		optimizedRouteData: z.string().min(1).optional(),
...
export function CreateSalesOrderInputSchema(): z.ZodObject<
	Properties<CreateSalesOrderInput>
> {
	return z.object({
		clientId: z.string(),
...
export function CreateSalesOrderItemInputSchema(): z.ZodObject<
	Properties<CreateSalesOrderItemInput>
> {
	return z.object({
		productId: z.string(),
...
export function CreateShipmentLegEventInputSchema(): z.ZodObject<
	Properties<CreateShipmentLegEventInput>
> {
	return z.object({
...
export function CreateShipmentLegInputSchema(): z.ZodObject<
	Properties<CreateShipmentLegInput>
> {
	return z.object({
...
export function CreateStockTransferInputSchema(): z.ZodObject<
	Properties<CreateStockTransferInput>
> {
	return z.object({
...
export function CreateSupplierInputSchema(): z.ZodObject<
	Properties<CreateSupplierInput>
> {
	return z.object({
		contactPerson: z.string().min(1).optional(),
...
export function CreateSurchargeInputSchema(): z.ZodObject<
	Properties<CreateSurchargeInput>
> {
	return z.object({
		amount: z.number().min(0),
...
export function CreateTaskEventInputSchema(): z.ZodObject<
	Properties<CreateTaskEventInput>
> {
	return z.object({
		deliveryTaskId: z.string(),
		latitude: z.number().min(-90).max(90).optional(),
...
export function CreateTaskItemInputSchema(): z.ZodObject<
	Properties<CreateTaskItemInput>
> {
	return z.object({
		batchId: z.string().optional(),
...
export function CreateTripInputSchema(): z.ZodObject<
	Properties<CreateTripInput>
> {
	return z.object({
		driverId: z.string().optional(),
		endLocation: z.string().min(1).optional(),
...
export function CreateTripStopInputSchema(): z.ZodObject<
	Properties<CreateTripStopInput>
> {
	return z.object({
...
export function CreateVehicleInputSchema(): z.ZodObject<
	Properties<CreateVehicleInput>
> {
	return z.object({
...
export function CreateVehicleMaintenanceInputSchema(): z.ZodObject<
	Properties<CreateVehicleMaintenanceInput>
> {
	return z.object({
...
export function CreateWarehouseInputSchema(): z.ZodObject<
	Properties<CreateWarehouseInput>
> {
	return z.object({
		address: z.string().min(1).optional(),
		city: z.string().min(1).optional(),
...
export function CreateWmsProductInputSchema(): z.ZodObject<
	Properties<CreateWmsProductInput>
> {
	return z.object({
		barcode: z.string().min(1).optional(),
		clientId: z.string().optional(),
...
export function UpdateBillingInvoiceInputSchema(): z.ZodObject<
	Properties<UpdateBillingInvoiceInput>
> {
	return z.object({
...
export function UpdateBinThresholdInputSchema(): z.ZodObject<
	Properties<UpdateBinThresholdInput>
> {
	return z.object({
		alertThreshold: z.number().min(0).optional(),
		isActive: z.boolean().optional(),
...
export function UpdateCampaignInputSchema(): z.ZodObject<
	Properties<UpdateCampaignInput>
> {
	return z.object({
		budget: z.number().min(0).optional(),
		endDate: z.coerce.date().optional(),
...
export function UpdateCarrierInputSchema(): z.ZodObject<
	Properties<UpdateCarrierInput>
> {
	return z.object({
		contactEmail: z.string().min(1).optional(),
		contactPerson: z.string().min(1).optional(),
...
export function UpdateCarrierRateInputSchema(): z.ZodObject<
	Properties<UpdateCarrierRateInput>
> {
	return z.object({
		destination: z.string().min(1).optional(),
		origin: z.string().min(1).optional(),
...
export function UpdateCaseInputSchema(): z.ZodObject<
	Properties<UpdateCaseInput>
> {
	return z.object({
		priority: CasePrioritySchema.optional(),
		status: CaseStatusSchema.optional(),
...
export function UpdateClientAccountInputSchema(): z.ZodObject<
	Properties<UpdateClientAccountInput>
> {
	return z.object({
		availableCredit: z.number().min(0).optional(),
		creditLimit: z.number().min(0).optional(),
...
export function UpdateCompanyInputSchema(): z.ZodObject<
	Properties<UpdateCompanyInput>
> {
	return z.object({
		annualRevenue: z.number().min(0).optional(),
		city: z.string().min(1).optional(),
...
export function UpdateCreditNoteInputSchema(): z.ZodObject<
	Properties<UpdateCreditNoteInput>
> {
	return z.object({
...
export function UpdateCustomerTrackingLinkInputSchema(): z.ZodObject<
	Properties<UpdateCustomerTrackingLinkInput>
> {
	return z.object({
...
export function UpdateDeliveryRouteInputSchema(): z.ZodObject<
	Properties<UpdateDeliveryRouteInput>
> {
	return z.object({
...
export function UpdateDeliveryTaskInputSchema(): z.ZodObject<
	Properties<UpdateDeliveryTaskInput>
> {
	return z.object({
		actualArrivalTime: z.string().min(1).optional(),
...
export function UpdateDisputeInputSchema(): z.ZodObject<
	Properties<UpdateDisputeInput>
> {
	return z.object({
		disputedAmount: z.number().min(0).optional(),
		reason: z.string().min(1).optional(),
...
export function UpdateDocumentInputSchema(): z.ZodObject<
	Properties<UpdateDocumentInput>
> {
	return z.object({
...
export function UpdateDriverInputSchema(): z.ZodObject<
	Properties<UpdateDriverInput>
> {
	return z.object({
		contactPhone: z.string().min(1).optional(),
		licenseExpiryDate: z.string().optional(),
...
export function UpdateDriverLocationInputSchema(): z.ZodObject<
	Properties<UpdateDriverLocationInput>
> {
	return z.object({
		accuracy: z.number().min(0).optional(),
		altitude: z.number().min(-500).optional(),
...
export function UpdateDriverScheduleInputSchema(): z.ZodObject<
	Properties<UpdateDriverScheduleInput>
> {
	return z.object({
...
export function UpdateExpenseInputSchema(): z.ZodObject<
	Properties<UpdateExpenseInput>
> {
	return z.object({
		amount: z.number().min(0).optional(),
		currency: CurrencySchema.optional(),
...
export function UpdateGeofenceEventInputSchema(): z.ZodObject<
	Properties<UpdateGeofenceEventInput>
> {
	return z.object({
...
export function UpdateGeofenceInputSchema(): z.ZodObject<
	Properties<UpdateGeofenceInput>
> {
	return z.object({
		latitude: z.number().min(-90).max(90).optional(),
		longitude: z.number().min(-180).max(180).optional(),
...
export function UpdateGpsPingInputSchema(): z.ZodObject<
	Properties<UpdateGpsPingInput>
> {
	return z.object({
		latitude: z.number().min(-90).max(90).optional(),
		longitude: z.number().min(-180).max(180).optional(),
...
export function UpdateInboundShipmentInputSchema(): z.ZodObject<
	Properties<UpdateInboundShipmentInput>
> {
	return z.object({
...
export function UpdateInboundShipmentItemInputSchema(): z.ZodObject<
	Properties<UpdateInboundShipmentItemInput>
> {
	return z.object({
...
export function UpdateInteractionInputSchema(): z.ZodObject<
	Properties<UpdateInteractionInput>
> {
	return z.object({
		interactionDate: z.coerce.date().optional(),
		notes: z.string().min(1).optional(),
...
export function UpdateInventoryAdjustmentInputSchema(): z.ZodObject<
	Properties<UpdateInventoryAdjustmentInput>
> {
	return z.object({
		notes: z.string().min(1).optional(),
...
export function UpdateInventoryBatchInputSchema(): z.ZodObject<
	Properties<UpdateInventoryBatchInput>
> {
	return z.object({
...
export function UpdateInventoryStockInputSchema(): z.ZodObject<
	Properties<UpdateInventoryStockInput>
> {
	return z.object({
...
export function UpdateInvoiceInputSchema(): z.ZodObject<
	Properties<UpdateInvoiceInput>
> {
	return z.object({
...
export function UpdateInvoiceItemInputSchema(): z.ZodObject<
	Properties<UpdateInvoiceItemInput>
> {
	return z.object({
		quantity: z.number().min(0.01),
	});
...
export function UpdateInvoiceLineItemInputSchema(): z.ZodObject<
	Properties<UpdateInvoiceLineItemInput>
> {
	return z.object({
		description: z.string().min(1).optional(),
		discountRate: z.number().min(0).max(100).optional(),
...
export function UpdateLocationInputSchema(): z.ZodObject<
...
export function UpdateNotificationInputSchema(): z.ZodObject<
	Properties<UpdateNotificationInput>
> {
	return z.object({
		isRead: z.boolean().optional(),
	});
...
export function UpdateOpportunityInputSchema(): z.ZodObject<
	Properties<UpdateOpportunityInput>
> {
	return z.object({
		dealValue: z.number().min(0).optional(),
		expectedCloseDate: z.coerce.date().optional(),
...
export function UpdateOpportunityProductInputSchema(): z.ZodObject<
	Properties<UpdateOpportunityProductInput>
> {
	return z.object({
		quantity: z.number().min(0.01),
	});
...
export function UpdateOutboundShipmentInputSchema(): z.ZodObject<
	Properties<UpdateOutboundShipmentInput>
> {
	return z.object({
		carrier: z.string().min(1).optional(),
		status: OutboundShipmentStatusSchema.optional(),
...
export function UpdateOutboundShipmentItemInputSchema(): z.ZodObject<
	Properties<UpdateOutboundShipmentItemInput>
> {
	return z.object({
...
export function UpdatePackageItemInputSchema(): z.ZodObject<
	Properties<UpdatePackageItemInput>
> {
	return z.object({
		expiryDate: z.string().min(1).optional(),
		lotNumber: z.string().min(1).optional(),
...
export function UpdatePartnerInvoiceInputSchema(): z.ZodObject<
	Properties<UpdatePartnerInvoiceInput>
> {
	return z.object({
		status: PartnerInvoiceStatusSchema.optional(),
	});
...
export function UpdatePartnerInvoiceItemInputSchema(): z.ZodObject<
	Properties<UpdatePartnerInvoiceItemInput>
> {
	return z.object({
		amount: z.number(),
	});
...
export function UpdatePaymentInputSchema(): z.ZodObject<
	Properties<UpdatePaymentInput>
> {
	return z.object({
		currency: z.string().min(1).optional(),
		exchangeRate: z.number().min(0).optional(),
...
export function UpdatePickBatchInputSchema(): z.ZodObject<
	Properties<UpdatePickBatchInput>
> {
	return z.object({
		actualDuration: z.number().min(0).optional(),
		assignedUserId: z.string().optional(),
...
export function UpdatePickBatchItemInputSchema(): z.ZodObject<
	Properties<UpdatePickBatchItemInput>
> {
	return z.object({
		actualPickTime: z.number().min(0).optional(),
		estimatedPickTime: z.number().min(0).optional(),
...
export function UpdateProofOfDeliveryInputSchema(): z.ZodObject<
	Properties<UpdateProofOfDeliveryInput>
> {
	return z.object({
		type: ProofTypeSchema.optional(),
	});
...
export function UpdatePutawayRuleInputSchema(): z.ZodObject<
	Properties<UpdatePutawayRuleInput>
> {
	return z.object({
		isActive: z.boolean().optional(),
		locationType: LocationTypeSchema.optional(),
...
export function UpdateQuoteInputSchema(): z.ZodObject<
	Properties<UpdateQuoteInput>
> {
	return z.object({
...
export function UpdateRateCardInputSchema(): z.ZodObject<
	Properties<UpdateRateCardInput>
> {
	return z.object({
		createdByUserId: z.string().optional(),
		description: z.string().min(1).optional(),
...
export function UpdateRateRuleInputSchema(): z.ZodObject<
	Properties<UpdateRateRuleInput>
> {
	return z.object({
...
export function UpdateReorderPointInputSchema(): z.ZodObject<
	Properties<UpdateReorderPointInput>
> {
	return z.object({
...
export function UpdateReturnInputSchema(): z.ZodObject<
	Properties<UpdateReturnInput>
> {
	return z.object({
		reason: z.string().min(1).optional(),
		status: ReturnStatusSchema.optional(),
...
export function UpdateReturnItemInputSchema(): z.ZodObject<
	Properties<UpdateReturnItemInput>
> {
	return z.object({
		condition: ReturnItemConditionSchema.optional(),
...
export function UpdateRouteInputSchema(): z.ZodObject<
	Properties<UpdateRouteInput>
> {
	return z.object({
		optimizedRouteData: z.string().min(1).optional(),
		totalDistance: z.number().min(0).optional(),
...
export function UpdateSalesOrderInputSchema(): z.ZodObject<
	Properties<UpdateSalesOrderInput>
> {
	return z.object({
		shippingAddress: z.string().min(1).optional(),
		status: SalesOrderStatusSchema.optional(),
...
export function UpdateSalesOrderItemInputSchema(): z.ZodObject<
	Properties<UpdateSalesOrderItemInput>
> {
	return z.object({
...
export function UpdateShipmentLegInputSchema(): z.ZodObject<
	Properties<UpdateShipmentLegInput>
> {
	return z.object({
		carrierId: z.string().optional(),
		endLocation: z.string().min(1).optional(),
...
export function UpdateStockTransferInputSchema(): z.ZodObject<
	Properties<UpdateStockTransferInput>
> {
	return z.object({
...
export function UpdateSupplierInputSchema(): z.ZodObject<
	Properties<UpdateSupplierInput>
> {
	return z.object({
		contactPerson: z.string().min(1).optional(),
		email: z.string().email().optional(),
...
export function UpdateSurchargeInputSchema(): z.ZodObject<
	Properties<UpdateSurchargeInput>
> {
	return z.object({
		amount: z.number().min(0).optional(),
...
export function UpdateTaskItemInputSchema(): z.ZodObject<
	Properties<UpdateTaskItemInput>
> {
	return z.object({
		completedAt: z.string().min(1).optional(),
		destinationLocationId: z.string().optional(),
...
export function UpdateTripInputSchema(): z.ZodObject<
	Properties<UpdateTripInput>
> {
	return z.object({
		endLocation: z.string().min(1).optional(),
		endTime: z.string().optional(),
...
export function UpdateTripStopInputSchema(): z.ZodObject<
	Properties<UpdateTripStopInput>
> {
	return z.object({
		actualArrivalTime: z.string().min(1).optional(),
...
export function UpdateVehicleInputSchema(): z.ZodObject<
	Properties<UpdateVehicleInput>
> {
	return z.object({
		capacityVolume: z.number().min(0).optional(),
		capacityWeight: z.number().min(0).optional(),
...
export function UpdateVehicleMaintenanceInputSchema(): z.ZodObject<
	Properties<UpdateVehicleMaintenanceInput>
> {
	return z.object({
		cost: z.number().optional(),
		notes: z.string().optional(),
...
export function UpdateWarehouseInputSchema(): z.ZodObject<
	Properties<UpdateWarehouseInput>
> {
	return z.object({
		address: z.string().min(1).optional(),
		city: z.string().min(1).optional(),
...
export function UpdateWmsProductInputSchema(): z.ZodObject<
	Properties<UpdateWmsProductInput>
> {
	return z.object({
		barcode: z.string().min(1).optional(),
		costPrice: z.number().min(0).optional(),
