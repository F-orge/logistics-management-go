...
export const PaginateDisputeContract = oc.input(DisputeRepository.schemas.paginateOptionSchema).output(OutputSchema.array());

export const RangeDisputeContract = oc.input(DisputeRepository.schemas.rangeOptionSchema).output(OutputSchema.array());

export const AnyDisputeContract = oc.input(z.uuid().array()).output(OutputSchema.array());

export const InsertDisputeContract = oc.input(DisputeRepository.schemas.InsertSchema).output(OutputSchema);

export const InsertManyDisputeContract = oc.input(DisputeRepository.schemas.InsertSchema.array()).output(OutputSchema.array());

export const UpdateDisputeContract = oc.input(z.object({id: z.uuid(), value: DisputeRepository.schemas.UpdateSchema})).output(OutputSchema);
