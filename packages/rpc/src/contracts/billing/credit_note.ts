...
export const PaginateCreditNoteContract = oc
  .input(CreditNoteRepository.schemas.paginateOptionSchema)
  .output(OutputSchema.array())

export const RangeCreditNoteContract = oc
  .input(CreditNoteRepository.schemas.rangeOptionSchema)
  .output(OutputSchema.array())

export const AnyCreditNoteContract = oc.input(z.uuid().array()).output(OutputSchema.array())

export const InsertCreditNoteContract = oc
  .input(CreditNoteRepository.schemas.InsertSchema)
  .output(OutputSchema)

export const InsertManyCreditNoteContract = oc
  .input(CreditNoteRepository.schemas.InsertSchema.array())
  .output(OutputSchema.array())

export const UpdateCreditNoteContract = oc
  .input(z.object({ id: z.uuid(), value: CreditNoteRepository.schemas.UpdateSchema }))
  .output(OutputSchema)

export const RemoveCreditNoteContract = oc
  .input(z.uuid())
