...
export const PaginateAccountTransactionContract = oc
  .input(AccountTransactionRepository.schemas.paginateOptionSchema)
  .output(OutputSchema.array())

export const RangeAccountTransactionContract = oc
  .input(AccountTransactionRepository.schemas.rangeOptionSchema)
  .output(OutputSchema.array())

export const AnyAccountTransactionContract = oc.input(z.uuid().array()).output(OutputSchema.array())

export const InsertAccountTransactionContract = oc
  .input(AccountTransactionRepository.schemas.InsertSchema)
  .output(OutputSchema)

export const InsertManyAccountTransactionContract = oc
  .input(AccountTransactionRepository.schemas.InsertSchema.array())
  .output(OutputSchema.array())

export const UpdateAccountTransactionContract = oc
  .input(z.object({ id: z.uuid(), value: AccountTransactionRepository.schemas.UpdateSchema }))
  .output(OutputSchema)

export const RemoveAccountTransactionContract = oc
  .input(z.uuid())
