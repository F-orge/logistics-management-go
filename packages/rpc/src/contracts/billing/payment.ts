...
export const PaginatePaymentContract = oc
  .input(PaymentRepository.schemas.paginateOptionSchema)
  .output(OutputSchema.array())

export const RangePaymentContract = oc
  .input(PaymentRepository.schemas.rangeOptionSchema)
  .output(OutputSchema.array())

export const AnyPaymentContract = oc.input(z.uuid().array()).output(OutputSchema.array())

export const InsertPaymentContract = oc
  .input(PaymentRepository.schemas.InsertSchema)
  .output(OutputSchema)

export const InsertManyPaymentContract = oc
  .input(PaymentRepository.schemas.InsertSchema.array())
  .output(OutputSchema.array())

export const UpdatePaymentContract = oc
  .input(z.object({ id: z.uuid(), value: PaymentRepository.schemas.UpdateSchema }))
  .output(OutputSchema)

export const RemovePaymentContract = oc
  .input(z.uuid())
