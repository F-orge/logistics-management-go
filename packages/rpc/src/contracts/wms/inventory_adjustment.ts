...
export const PaginateInventoryAdjustmentContract = oc
  .input(InventoryAdjustmentRepository.schemas.paginateOptionSchema)
  .output(OutputSchema.array())

export const RangeInventoryAdjustmentContract = oc
  .input(InventoryAdjustmentRepository.schemas.rangeOptionSchema)
  .output(OutputSchema.array())

export const AnyInventoryAdjustmentContract = oc
  .input(z.uuid().array())
  .output(OutputSchema.array())

export const InsertInventoryAdjustmentContract = oc
  .input(InventoryAdjustmentRepository.schemas.InsertSchema)
  .output(OutputSchema)

export const InsertManyInventoryAdjustmentContract = oc
  .input(InventoryAdjustmentRepository.schemas.InsertSchema.array())
  .output(OutputSchema.array())

export const UpdateInventoryAdjustmentContract = oc
  .input(z.object({ id: z.uuid(), value: InventoryAdjustmentRepository.schemas.UpdateSchema }))
  .output(OutputSchema)

export const RemoveInventoryAdjustmentContract = oc
  .input(z.uuid())
