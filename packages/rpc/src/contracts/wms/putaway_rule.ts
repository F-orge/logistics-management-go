...
export const PaginatePutawayRuleContract = oc
  .input(PutawayRuleRepository.schemas.paginateOptionSchema)
  .output(OutputSchema.array())

export const RangePutawayRuleContract = oc
  .input(PutawayRuleRepository.schemas.rangeOptionSchema)
  .output(OutputSchema.array())

export const AnyPutawayRuleContract = oc.input(z.uuid().array()).output(OutputSchema.array())

export const InsertPutawayRuleContract = oc
  .input(PutawayRuleRepository.schemas.InsertSchema)
  .output(OutputSchema)

export const InsertManyPutawayRuleContract = oc
  .input(PutawayRuleRepository.schemas.InsertSchema.array())
  .output(OutputSchema.array())

export const UpdatePutawayRuleContract = oc
  .input(z.object({ id: z.uuid(), value: PutawayRuleRepository.schemas.UpdateSchema }))
  .output(OutputSchema)

export const RemovePutawayRuleContract = oc
  .input(z.uuid())
