...
export const PaginateInventoryBatchContract = oc
  .input(InventoryBatchRepository.schemas.paginateOptionSchema)
  .output(OutputSchema.array())

export const RangeInventoryBatchContract = oc
  .input(InventoryBatchRepository.schemas.rangeOptionSchema)
  .output(OutputSchema.array())

export const AnyInventoryBatchContract = oc.input(z.uuid().array()).output(OutputSchema.array())

export const InsertInventoryBatchContract = oc
  .input(InventoryBatchRepository.schemas.InsertSchema)
  .output(OutputSchema)

export const InsertManyInventoryBatchContract = oc
  .input(InventoryBatchRepository.schemas.InsertSchema.array())
  .output(OutputSchema.array())

export const UpdateInventoryBatchContract = oc
  .input(z.object({ id: z.uuid(), value: InventoryBatchRepository.schemas.UpdateSchema }))
  .output(OutputSchema)

export const RemoveInventoryBatchContract = oc
  .input(z.uuid())
