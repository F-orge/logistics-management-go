...
export const UpdateSalesOrderContract = oc
  .input(z.object({ id: z.uuid(), value: SalesOrderRepository.schemas.UpdateSchema }))
  .output(OutputSchema)
