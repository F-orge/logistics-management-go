...
export const PaginateInventoryStockContract = oc
  .input(InventoryStockRepository.schemas.paginateOptionSchema)
  .output(OutputSchema.array())

export const RangeInventoryStockContract = oc
  .input(InventoryStockRepository.schemas.rangeOptionSchema)
  .output(OutputSchema.array())

export const AnyInventoryStockContract = oc.input(z.uuid().array()).output(OutputSchema.array())

export const InsertInventoryStockContract = oc
  .input(InventoryStockRepository.schemas.InsertSchema)
  .output(OutputSchema)

export const InsertManyInventoryStockContract = oc
  .input(InventoryStockRepository.schemas.InsertSchema.array())
  .output(OutputSchema.array())

export const UpdateInventoryStockContract = oc
  .input(z.object({ id: z.uuid(), value: InventoryStockRepository.schemas.UpdateSchema }))
  .output(OutputSchema)

export const RemoveInventoryStockContract = oc
  .input(z.uuid())
