...
export const PaginatePackageContract = oc.input(PackageRepository.schemas.paginateOptionSchema).output(OutputSchema.array());

export const RangePackageContract = oc.input(PackageRepository.schemas.rangeOptionSchema).output(OutputSchema.array());

export const AnyPackageContract = oc.input(z.uuid().array()).output(OutputSchema.array());

export const InsertPackageContract = oc.input(PackageRepository.schemas.InsertSchema.extend({items:PackageItemRepository.schemas.InsertSchema.array()})).output(OutputSchema);

export const InsertManyPackageContract = oc.input(PackageRepository.schemas.InsertSchema.extend({items:PackageItemRepository.schemas.InsertSchema.array()}).array()).output(OutputSchema.array());

export const UpdatePackageContract = oc.input(z.object({id: z.uuid(), value: PackageRepository.schemas.UpdateSchema})).output(OutputSchema);
...
export const InsertPackageItemContract = oc.input(PackageItemRepository.schemas.InsertSchema).output(OutputSchema);

export const InsertManyPackageItemContract = oc.input(PackageItemRepository.schemas.InsertSchema.array()).output(OutputSchema.array());

export const UpdatePackageItemContract = oc.input(z.object({id: z.uuid(), value: PackageItemRepository.schemas.UpdateSchema})).output(OutputSchema);
