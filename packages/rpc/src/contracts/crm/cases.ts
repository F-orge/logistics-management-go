...
export const PaginateCaseContract = oc
  .input(CaseRepository.schemas.paginateOptionSchema)
  .output(OutputSchema.array())

export const RangeCaseContract = oc
  .input(CaseRepository.schemas.rangeOptionSchema)
  .output(OutputSchema.array())
...
export const InsertManyCaseContract = oc
  .input(CaseRepository.schemas.InsertSchema.array())
  .output(OutputSchema.array())

export const UpdateCaseContract = oc
  .input(z.object({ id: z.uuid(), value: CaseRepository.schemas.UpdateSchema }))
  .output(OutputSchema)

export const RemoveCaseContract = oc
  .input(z.uuid())
