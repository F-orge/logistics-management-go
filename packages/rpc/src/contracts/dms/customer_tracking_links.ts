...
export const PaginateCustomerTrackingLinkContract = oc
  .input(CustomerTrackingLinkRepository.schemas.paginateOptionSchema)
  .output(OutputSchema.array())

export const RangeCustomerTrackingLinkContract = oc
  .input(CustomerTrackingLinkRepository.schemas.rangeOptionSchema)
  .output(OutputSchema.array())

export const AnyCustomerTrackingLinkContract = oc
  .input(z.uuid().array())
  .output(OutputSchema.array())

export const InsertCustomerTrackingLinkContract = oc
  .input(CustomerTrackingLinkRepository.schemas.InsertSchema)
  .output(OutputSchema)

export const InsertManyCustomerTrackingLinkContract = oc
  .input(CustomerTrackingLinkRepository.schemas.InsertSchema.array())
  .output(OutputSchema.array())

export const UpdateCustomerTrackingLinkContract = oc
  .input(z.object({ id: z.uuid(), value: CustomerTrackingLinkRepository.schemas.UpdateSchema }))
  .output(OutputSchema)

export const RemoveCustomerTrackingLinkContract = oc
  .input(z.uuid())
